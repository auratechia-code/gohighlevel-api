...
generated_at: "2026-03-28T17:50:27.814951"
tags: ["docs", "concept"]
---
...
The
saasProducts
array contains all the features included in this plan
The
prices
array defines different billing intervals (monthly, yearly) with their respective amounts
The
addOns
array can include additional services or features that can be purchased separately
Schema
​
...
"description"
:
"Array of product features included in this plan"
}
,
"addOns"
:
...
"description"
:
"Array of additional services or features available as add-ons"
}
,
"planLevel"
:
...
"description"
:
"Numeric level indicating the tier of the plan"
}
,
"trialPeriod"
:
...
"description"
:
"Billing frequency (e.g., 'month', 'year')"
}
,
"active"
:
...
"description"
:
"Identifier for the plan category"
}
,
"snapshotId"
:
...
"description"
:
"Identifier for the plan snapshot"
}
,
"productId"
:
...
"description"
:
"Flag indicating if this is a SaaS V2 plan"
}
,
"createdAt"
:
...
​
id
: Unique identifier for the price (usually Stripe price ID)
billingInterval
: Billing frequency ("month", "year", etc.)
active
: Boolean indicating if this price is currently available
amount
: Price amount in cents (e.g., 29700 = $297.00)
currency
: Currency code (e.g., "usd")
symbol
: Currency symbol (e.g., "$")
...
"id"
:
"price_1RrFciCScnf89tZoANu4chyo"
,
"billingInterval"
:
"month"
...
"id"
:
"price_1RrFciCScnf89tZo8V8JTFdZ"
,
"billingInterval"
:
"year"
...
The
saasProducts
array contains feature identifiers that correspond to specific functionality in the system.
The
isSaaSV2
flag helps distinguish between legacy and newer plan architectures.
Ensure your webhook listener can handle the array structure of the response.
The
traceId
can be used for debugging and correlating events across your system.
Share your feedback
★
★
★
