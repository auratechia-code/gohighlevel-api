...
async function executeRequest() {
  try {
    const response = await ghl.api.request('PUT', 'https://services.leadconnectorhq.com/calendars/schedules/:id', {
...
unirest('PUT', 'https://services.leadconnectorhq.com/calendars/schedules/:id')
  .headers({
    'Authorization': 'Bearer <YOUR_ACCESS_TOKEN>',
    'Version': '2021-07-28',
    'Content-Type': 'application/json'
...
$response = $client->request('PUT', 'https://services.leadconnectorhq.com/calendars/schedules/:id', [
  'headers' => $headers,
  'body' => '{
  "name": "string",
  "rules": "string",
