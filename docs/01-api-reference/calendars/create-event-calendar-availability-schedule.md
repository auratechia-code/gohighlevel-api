...
async function executeRequest() {
  try {
    const response = await ghl.api.request('POST', 'https://services.leadconnectorhq.com/calendars/schedules/event-calendar/:calendarId', {
...
unirest('POST', 'https://services.leadconnectorhq.com/calendars/schedules/event-calendar/:calendarId')
  .headers({
    'Authorization': 'Bearer <YOUR_ACCESS_TOKEN>',
    'Version': '2021-07-28',
    'Content-Type': 'application/json'
...
$response = $client->request('POST', 'https://services.leadconnectorhq.com/calendars/schedules/event-calendar/:calendarId', [
  'headers' => $headers,
  'body' => '{
  "rules": "string",
  "type": "string",
