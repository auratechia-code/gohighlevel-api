...
async function executeRequest() {
  try {
    const response = await ghl.api.request('POST', 'https://services.leadconnectorhq.com/calendars/services/locations', {
...
unirest('POST', 'https://services.leadconnectorhq.com/calendars/services/locations')
  .headers({
    'Authorization': 'Bearer <YOUR_ACCESS_TOKEN>',
    'Version': '2021-07-28',
    'Content-Type': 'application/json'
...
$response = $client->request('POST', 'https://services.leadconnectorhq.com/calendars/services/locations', [
  'headers' => $headers,
  'body' => '{
  "locationId": "string",
  "name": "string",
