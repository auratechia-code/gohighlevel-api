...
async function executeRequest() {
  try {
    const response = await ghl.api.request('DELETE', 'https://services.leadconnectorhq.com/payments/coupon', {
...
unirest('DELETE', 'https://services.leadconnectorhq.com/payments/coupon')
  .headers({
    'Authorization': 'Bearer <YOUR_ACCESS_TOKEN>',
    'Version': '2021-07-28',
    'Content-Type': 'application/json'
...
$response = $client->request('DELETE', 'https://services.leadconnectorhq.com/payments/coupon', [
  'headers' => $headers,
  'body' => '{
  "altId": "string",
  "altType": "string",
