...
| **Scopes Required** | `payments/integration.write` |
...
async function executeRequest() {
  try {
    const response = await ghl.api.request('POST', 'https://services.leadconnectorhq.com/payments/integrations/provider/whitelabel', {
...
unirest('POST', 'https://services.leadconnectorhq.com/payments/integrations/provider/whitelabel')
  .headers({
    'Authorization': 'Bearer <YOUR_ACCESS_TOKEN>',
    'Version': '2021-07-28',
    'Content-Type': 'application/json'
...
$response = $client->request('POST', 'https://services.leadconnectorhq.com/payments/integrations/provider/whitelabel', [
  'headers' => $headers,
  'body' => '{
  "altId": "string",
  "altType": "string",
