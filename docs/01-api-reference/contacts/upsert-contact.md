...
| :--- | :--- |
| **HTTP Method** | POST |
| **Endpoint URL** | `https://services.leadconnectorhq.com/contacts/upsert` |
...
| **createNewIfDuplicateAllowed** | `boolean` | No |  |
...
curl --request POST \
  ...
  "companyName": "string",
  "assignedTo": "string",
  "createNewIfDuplicateAllowed": true
}'
```
...
async function executeRequest() {
  try {
    const response = await ghl.api.request('POST', 'https://services.leadconnectorhq.com/contacts/upsert', {
...
unirest('POST', 'https://services.leadconnectorhq.com/contacts/upsert')
  .headers({
    'Authorization': 'Bearer <YOUR_ACCESS_TOKEN>',
    'Version': '2021-07-28',
    'Content-Type': 'application/json'
...
$response = $client->request('POST', 'https://services.leadconnectorhq.com/contacts/upsert', [
  'headers' => $headers,
  'body' => '{
  "firstName": "string",
  "lastName": "string",
...
HttpRequest request = HttpRequest.newBuilder()
    .uri(URI.create("https://services.leadconnectorhq.com/contacts/upsert"))
    .header("Authorization", "Bearer <YOUR_ACCESS_TOKEN>")
    .header("Version", "2021-07-28")
    .header("Content-Type", "application/json")
