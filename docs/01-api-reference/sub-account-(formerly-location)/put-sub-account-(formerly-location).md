...
| :--- | :--- |
| **HTTP Method** | PUT |
| **Endpoint URL** | `https://services.leadconnectorhq.com/locations/:locationId` |
...
| **apiKey** | `string` | No |  |
| **domain** | `string` | No |  |
| **snapshot** | `object` | Yes | The snapshot to be updated in the location. id string required Snaptshot ID Example: XXXXXXXXXXX override boolean If you want override all conflicted assets then pass true. Default value is false. Default value: false Example: false |
| **id** | `string` | No |  |
| **override** | `boolean` | No |  |
...
async function executeRequest() {
  try {
    const response = await ghl.api.request('PUT', 'https://services.leadconnectorhq.com/locations/:locationId', {
...
unirest('PUT', 'https://services.leadconnectorhq.com/locations/:locationId')
  .headers({
    'Authorization': 'Bearer <YOUR_ACCESS_TOKEN>',
    'Version': '2021-07-28',
    'Content-Type': 'application/json'
...
$response = $client->request('PUT', 'https://services.leadconnectorhq.com/locations/:locationId', [
  'headers' => $headers,
  'body' => '{
  "name": "string",
  "phone": "string",
...
HttpRequest request = HttpRequest.newBuilder()
    .uri(URI.create("https://services.leadconnectorhq.com/locations/:locationId"))
    .header("Authorization", "Bearer <YOUR_ACCESS_TOKEN>")
    .header("Version", "2021-07-28")
    .header("Content-Type", "application/json")
...
$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/locations/:locationId' -Method 'PUT' -Headers $headers -Body $body
