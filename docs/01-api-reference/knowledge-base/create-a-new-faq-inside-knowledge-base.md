...
async function executeRequest() {
  try {
    const response = await ghl.api.request('POST', 'https://services.leadconnectorhq.com/knowledge-bases/faqs', {
...
unirest('POST', 'https://services.leadconnectorhq.com/knowledge-bases/faqs')
  .headers({
    'Authorization': 'Bearer <YOUR_ACCESS_TOKEN>',
    'Version': '2021-07-28',
    'Content-Type': 'application/json'
...
$response = $client->request('POST', 'https://services.leadconnectorhq.com/knowledge-bases/faqs', [
  'headers' => $headers,
  'body' => '{
  "locationId": "string",
  "question": "string",
