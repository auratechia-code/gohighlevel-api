...
| :--- | :--- |
| **HTTP Method** | GET |
| **Endpoint URL** | `https://services.leadconnectorhq.com/knowledge-bases/crawler/status` |
| **Scopes Required** | `N/A` |
...
| Name | Type | Required | Description |
| :--- | :--- | :--- | :--- |
| **locationId** | `` | Yes | operationId string required operation id as string Example: 1 |
| **operationId** | `` | Yes | knowledgeBaseId string required knowledge base id Example: jjkkxftgvbhjmn, |
| **knowledgeBaseId** | `` | No |  |
...
async function executeRequest() {
  try {
    const response = await ghl.api.request('GET', 'https://services.leadconnectorhq.com/knowledge-bases/crawler/status', {
...
unirest('GET', 'https://services.leadconnectorhq.com/knowledge-bases/crawler/status')
  .headers({
    'Authorization': 'Bearer <YOUR_ACCESS_TOKEN>',
    'Version': '2021-07-28',
    'Content-Type': 'application/json'
...
$response = $client->request('GET', 'https://services.leadconnectorhq.com/knowledge-bases/crawler/status', [
  'headers' => $headers,
  'body' => '{}'
]);
...
HttpRequest request = HttpRequest.newBuilder()
    .uri(URI.create("https://services.leadconnectorhq.com/knowledge-bases/crawler/status"))
    .header("Authorization", "Bearer <YOUR_ACCESS_TOKEN>")
    .header("Version", "2021-07-28")
    .header("Content-Type", "application/json")
...
$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/knowledge-bases/crawler/status' -Method 'GET' -Headers $headers -Body $body
