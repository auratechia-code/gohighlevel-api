...
async function executeRequest() {
  try {
    const response = await ghl.api.request('POST', 'https://services.leadconnectorhq.com/invoices/estimate/template', {
...
unirest('POST', 'https://services.leadconnectorhq.com/invoices/estimate/template')
  .headers({
    'Authorization': 'Bearer <YOUR_ACCESS_TOKEN>',
    'Version': '2021-07-28',
    'Content-Type': 'application/json'
...
$response = $client->request('POST', 'https://services.leadconnectorhq.com/invoices/estimate/template', [
  'headers' => $headers,
  'body' => '{
  "altId": "string",
  "altType": "string",
