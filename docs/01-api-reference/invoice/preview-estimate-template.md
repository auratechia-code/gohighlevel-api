...
| :--- | :--- |
| **HTTP Method** | GET |
| **Endpoint URL** | `https://services.leadconnectorhq.com/invoices/estimate/template/preview` |
...
| **altType** | `` | Yes | templateId string required Template Id Example: 5f9d6d8b1b2d2c001f2d9e4b |
| **templateId** | `` | No |  |
...
async function executeRequest() {
  try {
    const response = await ghl.api.request('GET', 'https://services.leadconnectorhq.com/invoices/estimate/template/preview', {
...
unirest('GET', 'https://services.leadconnectorhq.com/invoices/estimate/template/preview')
  .headers({
    'Authorization': 'Bearer <YOUR_ACCESS_TOKEN>',
    'Version': '2021-07-28',
    'Content-Type': 'application/json'
...
$response = $client->request('GET', 'https://services.leadconnectorhq.com/invoices/estimate/template/preview', [
  'headers' => $headers,
  'body' => '{}'
]);
...
HttpRequest request = HttpRequest.newBuilder()
    .uri(URI.create("https://services.leadconnectorhq.com/invoices/estimate/template/preview"))
    .header("Authorization", "Bearer <YOUR_ACCESS_TOKEN>")
    .header("Version", "2021-07-28")
    .header("Content-Type", "application/json")
...
$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/invoices/estimate/template/preview' -Method 'GET' -Headers $headers -Body $body
