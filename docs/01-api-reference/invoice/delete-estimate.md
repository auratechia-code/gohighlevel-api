...
| :--- | :--- |
| **HTTP Method** | DELETE |
| **Endpoint URL** | `https://services.leadconnectorhq.com/invoices/estimate/:estimateId` |
...
async function executeRequest() {
  try {
    const response = await ghl.api.request('DELETE', 'https://services.leadconnectorhq.com/invoices/estimate/:estimateId', {
...
unirest('DELETE', 'https://services.leadconnectorhq.com/invoices/estimate/:estimateId')
  .headers({
    'Authorization': 'Bearer <YOUR_ACCESS_TOKEN>',
    'Version': '2021-07-28',
    'Content-Type': 'application/json'
...
$response = $client->request('DELETE', 'https://services.leadconnectorhq.com/invoices/estimate/:estimateId', [
  'headers' => $headers,
  'body' => '{
  "altId": "string",
  "altType": "string"
...
HttpRequest request = HttpRequest.newBuilder()
    .uri(URI.create("https://services.leadconnectorhq.com/invoices/estimate/:estimateId"))
    .header("Authorization", "Bearer <YOUR_ACCESS_TOKEN>")
    .header("Version", "2021-07-28")
    .header("Content-Type", "application/json")
