...
async function executeRequest() {
  try {
    const response = await ghl.api.request('POST', 'https://services.leadconnectorhq.com/invoices/schedule', {
...
unirest('POST', 'https://services.leadconnectorhq.com/invoices/schedule')
  .headers({
    'Authorization': 'Bearer <YOUR_ACCESS_TOKEN>',
    'Version': '2021-07-28',
    'Content-Type': 'application/json'
...
$response = $client->request('POST', 'https://services.leadconnectorhq.com/invoices/schedule', [
  'headers' => $headers,
  'body' => '{
  "altId": "string",
  "altType": "string",
