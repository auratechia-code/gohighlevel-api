...
| **offset** | `` | Yes | locationId string required The unique identifier for the location. Example: 3SwdhCsvxI8Au3KsPJt6 |
| **locationId** | `` | No | ids string To filter the response only with the given price ids, Please provide with comma separated Example: 6241712be68f7a98102ba272,632027d51f7876cd3020213d |
| **ids** | `` | No |  |
...
async function executeRequest() {
  try {
    const response = await ghl.api.request('GET', 'https://services.leadconnectorhq.com/products/:productId/price', {
...
unirest('GET', 'https://services.leadconnectorhq.com/products/:productId/price')
  .headers({
    'Authorization': 'Bearer <YOUR_ACCESS_TOKEN>',
    'Version': '2021-07-28',
    'Content-Type': 'application/json'
...
$response = $client->request('GET', 'https://services.leadconnectorhq.com/products/:productId/price', [
  'headers' => $headers,
  'body' => '{}'
]);
...
$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/products/:productId/price' -Method 'GET' -Headers $headers -Body $body
