...
| **offset** | `` | Yes | altId string required Location Id or Agency Id Example: 6578278e879ad2646715ba9c |
| **altId** | `` | Yes | altType string required Possible values: [ location ] |
| **altType** | `` | No | search string Search string for Variant Search Example: Product Name |
| **search** | `` | No |  |
...
async function executeRequest() {
  try {
    const response = await ghl.api.request('GET', 'https://services.leadconnectorhq.com/products/inventory', {
...
unirest('GET', 'https://services.leadconnectorhq.com/products/inventory')
  .headers({
    'Authorization': 'Bearer <YOUR_ACCESS_TOKEN>',
    'Version': '2021-07-28',
    'Content-Type': 'application/json'
...
$response = $client->request('GET', 'https://services.leadconnectorhq.com/products/inventory', [
  'headers' => $headers,
  'body' => '{}'
]);
...
$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/products/inventory' -Method 'GET' -Headers $headers -Body $body
