...
| **skipLegacyWatermark** | `boolean` | No |  |
| **status** | `object` | No |  |
| **skipDateTime** | `string` | No |  |
...
async function executeRequest() {
  try {
    const response = await ghl.api.request('PUT', 'https://services.leadconnectorhq.com/social-media-posting/category/queues/:queueId', {
...
unirest('PUT', 'https://services.leadconnectorhq.com/social-media-posting/category/queues/:queueId')
  .headers({
    'Authorization': 'Bearer <YOUR_ACCESS_TOKEN>',
    'Version': '2021-07-28',
    'Content-Type': 'application/json'
...
$response = $client->request('PUT', 'https://services.leadconnectorhq.com/social-media-posting/category/queues/:queueId', [
  'headers' => $headers,
  'body' => '{
  "locationId": "string",
  "skipLegacyWatermark": true,
