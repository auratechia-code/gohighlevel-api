...
generated_at: "2026-03-28T17:50:27.823824"
tags: ["docs", "concept"]
---
...
Turn your CRM configurations into a revenue-generating product.
Broaden Your Reach:
Leverage HighLevel’s App Marketplace to reach a wider audience.
Secure Your Assets:
Ensure your intellectual property is protected from unauthorized use.
...
Configure your app:
Name:
Provide a clear and descriptive name for your app.
App Type:
Set the type to Public.
Distribution Type:
Choose between:
Agency:
Charge agencies directly.
Sub-Account:
Charge sub-accounts each time the Snapshot is pushed.
Listing Type:
Select either Standard or White-Label (recommended for broader reach).
...
Paid:
Charge a one-time fee, monthly, or yearly subscription.
...
Click
Submit for Review
. The HighLevel team will review your app for white-label compatibility within 7-10 days.
Protecting Your Intellectual Property (IP)
​
When you enable
Get Marketplace Share Link
, IP Protection is automatically applied. This ensures:
...
White-Label:
Removes branding, increasing the app’s appeal across various HighLevel customers.
Standard:
Retains visible branding, which may limit its reach.
