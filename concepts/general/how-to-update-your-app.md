...
generated_at: "2026-03-28T17:50:27.786009"
tags: ["docs", "concept"]
---
...
In Review
– Submitted to Marketplace review
(non-private apps only)
.
Live
– Approved and installable.
Deprecated
– Scheduled for removal and later uninstallation.
Disapproved
– Rejected review; behaves like a draft.
info
...
Draft
version is created
You cannot create another draft until the current
Draft
or
Disapproved
version is resolved.
...
​
HighLevel uses Semantic Versioning (
x.y.z
):
Major
...
Public Apps
→ Sent for Marketplace review. The update goes live only after approval.
Private Apps
→ Go live immediately
(no review)
.
info
Important:
Private App Install Limits apply at the
app level
, not the version level.
...
Major
Breaking changes
User must confirm before updating; manual update required
Minor
Backward-compatible features
Normal update flow
Patch
Bug fixes
Safe update; usually seamless
info
Important Module Note:
If you update modules
(except Custom Page)
, publish as a
Major
update.
...
Major
updates may show a confirmation screen
