...
async function executeRequest() {
  try {
    const response = await ghl.api.request('DELETE', 'https://services.leadconnectorhq.com/social-media-posting/:locationId/posts/:id', {
...
unirest('DELETE', 'https://services.leadconnectorhq.com/social-media-posting/:locationId/posts/:id')
  .headers({
    'Authorization': 'Bearer <YOUR_ACCESS_TOKEN>',
    'Version': '2021-07-28',
    'Content-Type': 'application/json'
...
$response = $client->request('DELETE', 'https://services.leadconnectorhq.com/social-media-posting/:locationId/posts/:id', [
  'headers' => $headers,
  'body' => '{}'
]);
...
$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/social-media-posting/:locationId/posts/:id' -Method 'DELETE' -Headers $headers -Body $body
