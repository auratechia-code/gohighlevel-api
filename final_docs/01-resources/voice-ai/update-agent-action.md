...
async function executeRequest() {
  try {
    const response = await ghl.api.request('PUT', 'https://services.leadconnectorhq.com/voice-ai/actions/:actionId', {
...
unirest('PUT', 'https://services.leadconnectorhq.com/voice-ai/actions/:actionId')
  .headers({
    'Authorization': 'Bearer <YOUR_ACCESS_TOKEN>',
    'Version': '2021-07-28',
    'Content-Type': 'application/json'
...
$response = $client->request('PUT', 'https://services.leadconnectorhq.com/voice-ai/actions/:actionId', [
  'headers' => $headers,
  'body' => '{
  "agentId": "string",
  "locationId": "string",
