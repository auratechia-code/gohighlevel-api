...
async function executeRequest() {
  try {
    const response = await ghl.api.request('POST', 'https://services.leadconnectorhq.com/voice-ai/agents', {
...
unirest('POST', 'https://services.leadconnectorhq.com/voice-ai/agents')
  .headers({
    'Authorization': 'Bearer <YOUR_ACCESS_TOKEN>',
    'Version': '2021-07-28',
    'Content-Type': 'application/json'
...
$response = $client->request('POST', 'https://services.leadconnectorhq.com/voice-ai/agents', [
  'headers' => $headers,
  'body' => '{
  "locationId": "string",
  "agentName": "string",
