...
| :--- | :--- |
| **HTTP Method** | PUT |
| **Endpoint URL** | `https://services.leadconnectorhq.com/store/shipping-zone/:shippingZoneId` |
| **Scopes Required** | `N/A` |
...
async function executeRequest() {
  try {
    const response = await ghl.api.request('PUT', 'https://services.leadconnectorhq.com/store/shipping-zone/:shippingZoneId', {
...
unirest('PUT', 'https://services.leadconnectorhq.com/store/shipping-zone/:shippingZoneId')
  .headers({
    'Authorization': 'Bearer <YOUR_ACCESS_TOKEN>',
    'Version': '2021-07-28',
    'Content-Type': 'application/json'
...
$response = $client->request('PUT', 'https://services.leadconnectorhq.com/store/shipping-zone/:shippingZoneId', [
  'headers' => $headers,
  'body' => '{
  "altId": "string",
  "altType": "string",
...
HttpRequest request = HttpRequest.newBuilder()
    .uri(URI.create("https://services.leadconnectorhq.com/store/shipping-zone/:shippingZoneId"))
    .header("Authorization", "Bearer <YOUR_ACCESS_TOKEN>")
    .header("Version", "2021-07-28")
    .header("Content-Type", "application/json")
...
url = URI("https://services.leadconnectorhq.com/store/shipping-zone/:shippingZoneId")
...
$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/store/shipping-zone/:shippingZoneId' -Method 'PUT' -Headers $headers -Body $body
