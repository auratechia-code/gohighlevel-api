...
async function executeRequest() {
  try {
    const response = await ghl.api.request('DELETE', 'https://services.leadconnectorhq.com/store/shipping-carrier/:shippingCarrierId', {
...
unirest('DELETE', 'https://services.leadconnectorhq.com/store/shipping-carrier/:shippingCarrierId')
  .headers({
    'Authorization': 'Bearer <YOUR_ACCESS_TOKEN>',
    'Version': '2021-07-28',
    'Content-Type': 'application/json'
...
$response = $client->request('DELETE', 'https://services.leadconnectorhq.com/store/shipping-carrier/:shippingCarrierId', [
  'headers' => $headers,
  'body' => '{}'
]);
...
$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/store/shipping-carrier/:shippingCarrierId' -Method 'DELETE' -Headers $headers -Body $body
