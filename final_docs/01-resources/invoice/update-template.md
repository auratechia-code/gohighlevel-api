...
async function executeRequest() {
  try {
    const response = await ghl.api.request('PUT', 'https://services.leadconnectorhq.com/invoices/template/:templateId', {
...
unirest('PUT', 'https://services.leadconnectorhq.com/invoices/template/:templateId')
  .headers({
    'Authorization': 'Bearer <YOUR_ACCESS_TOKEN>',
    'Version': '2021-07-28',
    'Content-Type': 'application/json'
...
$response = $client->request('PUT', 'https://services.leadconnectorhq.com/invoices/template/:templateId', [
  'headers' => $headers,
  'body' => '{
  "altId": "string",
  "altType": "string",
