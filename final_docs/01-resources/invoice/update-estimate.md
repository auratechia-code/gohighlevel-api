...
async function executeRequest() {
  try {
    const response = await ghl.api.request('PUT', 'https://services.leadconnectorhq.com/invoices/estimate/:estimateId', {
...
unirest('PUT', 'https://services.leadconnectorhq.com/invoices/estimate/:estimateId')
  .headers({
    'Authorization': 'Bearer <YOUR_ACCESS_TOKEN>',
    'Version': '2021-07-28',
    'Content-Type': 'application/json'
...
$response = $client->request('PUT', 'https://services.leadconnectorhq.com/invoices/estimate/:estimateId', [
  'headers' => $headers,
  'body' => '{
  "altId": "string",
  "altType": "string",
