...
async function executeRequest() {
  try {
    const response = await ghl.api.request('DELETE', 'https://services.leadconnectorhq.com/invoices/estimate/template/:templateId', {
...
unirest('DELETE', 'https://services.leadconnectorhq.com/invoices/estimate/template/:templateId')
  .headers({
    'Authorization': 'Bearer <YOUR_ACCESS_TOKEN>',
    'Version': '2021-07-28',
    'Content-Type': 'application/json'
...
$response = $client->request('DELETE', 'https://services.leadconnectorhq.com/invoices/estimate/template/:templateId', [
  'headers' => $headers,
  'body' => '{
  "altId": "string",
  "altType": "string"
