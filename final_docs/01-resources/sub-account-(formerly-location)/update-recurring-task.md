...
async function executeRequest() {
  try {
    const response = await ghl.api.request('PUT', 'https://services.leadconnectorhq.com/locations/:locationId/recurring-tasks/:id', {
...
unirest('PUT', 'https://services.leadconnectorhq.com/locations/:locationId/recurring-tasks/:id')
  .headers({
    'Authorization': 'Bearer <YOUR_ACCESS_TOKEN>',
    'Version': '2021-07-28',
    'Content-Type': 'application/json'
...
$response = $client->request('PUT', 'https://services.leadconnectorhq.com/locations/:locationId/recurring-tasks/:id', [
  'headers' => $headers,
  'body' => '{
  "title": "string",
  "description": "string",
