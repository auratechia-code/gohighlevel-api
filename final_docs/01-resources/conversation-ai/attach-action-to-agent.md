...
| :--- | :--- |
| **HTTP Method** | POST |
| **Endpoint URL** | `https://services.leadconnectorhq.com/conversation-ai/agents/:agentId/actions` |
...
async function executeRequest() {
  try {
    const response = await ghl.api.request('POST', 'https://services.leadconnectorhq.com/conversation-ai/agents/:agentId/actions', {
...
unirest('POST', 'https://services.leadconnectorhq.com/conversation-ai/agents/:agentId/actions')
  .headers({
    'Authorization': 'Bearer <YOUR_ACCESS_TOKEN>',
    'Version': '2021-07-28',
    'Content-Type': 'application/json'
...
$response = $client->request('POST', 'https://services.leadconnectorhq.com/conversation-ai/agents/:agentId/actions', [
  'headers' => $headers,
  'body' => '{
  "type": "string",
  "name": "string",
...
HttpRequest request = HttpRequest.newBuilder()
    .uri(URI.create("https://services.leadconnectorhq.com/conversation-ai/agents/:agentId/actions"))
    .header("Authorization", "Bearer <YOUR_ACCESS_TOKEN>")
    .header("Version", "2021-07-28")
    .header("Content-Type", "application/json")
