...
async function executeRequest() {
  try {
    const response = await ghl.api.request('GET', 'https://services.leadconnectorhq.com/conversation-ai/agents/:agentId/actions/:actionId', {
...
unirest('GET', 'https://services.leadconnectorhq.com/conversation-ai/agents/:agentId/actions/:actionId')
  .headers({
    'Authorization': 'Bearer <YOUR_ACCESS_TOKEN>',
    'Version': '2021-07-28',
    'Content-Type': 'application/json'
...
$response = $client->request('GET', 'https://services.leadconnectorhq.com/conversation-ai/agents/:agentId/actions/:actionId', [
  'headers' => $headers,
  'body' => '{}'
]);
...
$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/conversation-ai/agents/:agentId/actions/:actionId' -Method 'GET' -Headers $headers -Body $body
