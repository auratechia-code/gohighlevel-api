...
| :--- | :--- |
| **HTTP Method** | GET |
| **Endpoint URL** | `https://services.leadconnectorhq.com/forms/submissions` |
| **Scopes Required** | `forms.readonly` |
...
| **limit** | `` | No | formId string Filter submission by form id Example: jjusM6EOngDExnbo2DbU |
| **formId** | `` | No | q string Filter by contactId, name, email or phone no. Example: john@deo.com |
...
async function executeRequest() {
  try {
    const response = await ghl.api.request('GET', 'https://services.leadconnectorhq.com/forms/submissions', {
...
unirest('GET', 'https://services.leadconnectorhq.com/forms/submissions')
  .headers({
    'Authorization': 'Bearer <YOUR_ACCESS_TOKEN>',
    'Version': '2021-07-28',
    'Content-Type': 'application/json'
...
$response = $client->request('GET', 'https://services.leadconnectorhq.com/forms/submissions', [
  'headers' => $headers,
  'body' => '{}'
]);
...
HttpRequest request = HttpRequest.newBuilder()
    .uri(URI.create("https://services.leadconnectorhq.com/forms/submissions"))
    .header("Authorization", "Bearer <YOUR_ACCESS_TOKEN>")
    .header("Version", "2021-07-28")
    .header("Content-Type", "application/json")
...
$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/forms/submissions' -Method 'GET' -Headers $headers -Body $body
