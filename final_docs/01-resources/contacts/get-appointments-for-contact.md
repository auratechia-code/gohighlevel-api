...
| :--- | :--- |
| **HTTP Method** | GET |
| **Endpoint URL** | `https://services.leadconnectorhq.com/contacts/:contactId/appointments` |
...
async function executeRequest() {
  try {
    const response = await ghl.api.request('GET', 'https://services.leadconnectorhq.com/contacts/:contactId/appointments', {
...
unirest('GET', 'https://services.leadconnectorhq.com/contacts/:contactId/appointments')
  .headers({
    'Authorization': 'Bearer <YOUR_ACCESS_TOKEN>',
    'Version': '2021-07-28',
    'Content-Type': 'application/json'
...
$response = $client->request('GET', 'https://services.leadconnectorhq.com/contacts/:contactId/appointments', [
  'headers' => $headers,
  'body' => '{}'
]);
...
HttpRequest request = HttpRequest.newBuilder()
    .uri(URI.create("https://services.leadconnectorhq.com/contacts/:contactId/appointments"))
    .header("Authorization", "Bearer <YOUR_ACCESS_TOKEN>")
    .header("Version", "2021-07-28")
    .header("Content-Type", "application/json")
...
$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/contacts/:contactId/appointments' -Method 'GET' -Headers $headers -Body $body
