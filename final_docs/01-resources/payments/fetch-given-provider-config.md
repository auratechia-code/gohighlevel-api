...
| **Scopes Required** | `payments/custom-provider.readonly` |
...
async function executeRequest() {
  try {
    const response = await ghl.api.request('GET', 'https://services.leadconnectorhq.com/payments/custom-provider/connect', {
...
unirest('GET', 'https://services.leadconnectorhq.com/payments/custom-provider/connect')
  .headers({
    'Authorization': 'Bearer <YOUR_ACCESS_TOKEN>',
    'Version': '2021-07-28',
    'Content-Type': 'application/json'
...
$response = $client->request('GET', 'https://services.leadconnectorhq.com/payments/custom-provider/connect', [
  'headers' => $headers,
  'body' => '{}'
]);
...
$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/payments/custom-provider/connect' -Method 'GET' -Headers $headers -Body $body
