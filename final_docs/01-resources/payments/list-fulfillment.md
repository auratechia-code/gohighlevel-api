...
async function executeRequest() {
  try {
    const response = await ghl.api.request('GET', 'https://services.leadconnectorhq.com/payments/orders/:orderId/fulfillments', {
...
unirest('GET', 'https://services.leadconnectorhq.com/payments/orders/:orderId/fulfillments')
  .headers({
    'Authorization': 'Bearer <YOUR_ACCESS_TOKEN>',
    'Version': '2021-07-28',
    'Content-Type': 'application/json'
...
$response = $client->request('GET', 'https://services.leadconnectorhq.com/payments/orders/:orderId/fulfillments', [
  'headers' => $headers,
  'body' => '{}'
]);
...
$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/payments/orders/:orderId/fulfillments' -Method 'GET' -Headers $headers -Body $body
