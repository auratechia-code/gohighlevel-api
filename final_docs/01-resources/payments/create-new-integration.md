...
| :--- | :--- |
| **HTTP Method** | POST |
| **Endpoint URL** | `https://services.leadconnectorhq.com/payments/custom-provider/provider` |
...
| **paymentsUrl** | `string` | No |  |
| **queryUrl** | `string` | No |  |
| **imageUrl** | `string` | No |  |
| **supportsSubscriptionSchedule** | `boolean` | No |  |
...
async function executeRequest() {
  try {
    const response = await ghl.api.request('POST', 'https://services.leadconnectorhq.com/payments/custom-provider/provider', {
...
unirest('POST', 'https://services.leadconnectorhq.com/payments/custom-provider/provider')
  .headers({
    'Authorization': 'Bearer <YOUR_ACCESS_TOKEN>',
    'Version': '2021-07-28',
    'Content-Type': 'application/json'
...
$response = $client->request('POST', 'https://services.leadconnectorhq.com/payments/custom-provider/provider', [
  'headers' => $headers,
  'body' => '{
  "name": "string",
  "description": "string",
...
HttpRequest request = HttpRequest.newBuilder()
    .uri(URI.create("https://services.leadconnectorhq.com/payments/custom-provider/provider"))
    .header("Authorization", "Bearer <YOUR_ACCESS_TOKEN>")
    .header("Version", "2021-07-28")
    .header("Content-Type", "application/json")
