...
| **altType** | `` | Yes | id string required Coupon id Example: 6241712be68f7a98102ba272 |
| **id** | `` | Yes | code string required Coupon code Example: DEAL50 |
| **code** | `` | No |  |
...
async function executeRequest() {
  try {
    const response = await ghl.api.request('GET', 'https://services.leadconnectorhq.com/payments/coupon', {
...
unirest('GET', 'https://services.leadconnectorhq.com/payments/coupon')
  .headers({
    'Authorization': 'Bearer <YOUR_ACCESS_TOKEN>',
    'Version': '2021-07-28',
    'Content-Type': 'application/json'
...
$response = $client->request('GET', 'https://services.leadconnectorhq.com/payments/coupon', [
  'headers' => $headers,
  'body' => '{}'
]);
...
$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/payments/coupon' -Method 'GET' -Headers $headers -Body $body
