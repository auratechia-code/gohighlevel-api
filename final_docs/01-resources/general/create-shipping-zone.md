...
| :--- | :--- |
| **HTTP Method** | POST |
| **Endpoint URL** | `https://services.leadconnectorhq.com/store/shipping-zone` |
| **Scopes Required** | `N/A` |
...
async function executeRequest() {
  try {
    const response = await ghl.api.request('POST', 'https://services.leadconnectorhq.com/store/shipping-zone', {
...
unirest('POST', 'https://services.leadconnectorhq.com/store/shipping-zone')
  .headers({
    'Authorization': 'Bearer <YOUR_ACCESS_TOKEN>',
    'Version': '2021-07-28',
    'Content-Type': 'application/json'
...
$response = $client->request('POST', 'https://services.leadconnectorhq.com/store/shipping-zone', [
  'headers' => $headers,
  'body' => '{
  "altId": "string",
  "altType": "string",
...
HttpRequest request = HttpRequest.newBuilder()
    .uri(URI.create("https://services.leadconnectorhq.com/store/shipping-zone"))
    .header("Authorization", "Bearer <YOUR_ACCESS_TOKEN>")
    .header("Version", "2021-07-28")
    .header("Content-Type", "application/json")
...
url = URI("https://services.leadconnectorhq.com/store/shipping-zone")
...
$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/store/shipping-zone' -Method 'POST' -Headers $headers -Body $body
