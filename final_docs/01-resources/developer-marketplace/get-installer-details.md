...
| **Scopes Required** | `marketplace-installer-details.readonly` |
...
async function executeRequest() {
  try {
    const response = await ghl.api.request('GET', 'https://services.leadconnectorhq.com/marketplace/app/:appId/installations', {
...
unirest('GET', 'https://services.leadconnectorhq.com/marketplace/app/:appId/installations')
  .headers({
    'Authorization': 'Bearer <YOUR_ACCESS_TOKEN>',
    'Version': '2021-07-28',
    'Content-Type': 'application/json'
...
$response = $client->request('GET', 'https://services.leadconnectorhq.com/marketplace/app/:appId/installations', [
  'headers' => $headers,
  'body' => '{}'
]);
...
$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/marketplace/app/:appId/installations' -Method 'GET' -Headers $headers -Body $body
