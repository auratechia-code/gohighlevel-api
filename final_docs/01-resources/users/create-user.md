...
async function executeRequest() {
  try {
    const response = await ghl.api.request('POST', 'https://services.leadconnectorhq.com/users/', {
...
unirest('POST', 'https://services.leadconnectorhq.com/users/')
  .headers({
    'Authorization': 'Bearer <YOUR_ACCESS_TOKEN>',
    'Version': '2021-07-28',
    'Content-Type': 'application/json'
...
$response = $client->request('POST', 'https://services.leadconnectorhq.com/users/', [
  'headers' => $headers,
  'body' => '{
  "companyId": "string",
  "firstName": "string",
