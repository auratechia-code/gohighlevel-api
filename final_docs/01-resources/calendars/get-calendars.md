...
| Name | Type | Required | Description |
| :--- | :--- | :--- | :--- |
| **locationId** | `` | No | groupId string Group Id Example: BqTwX8QFwXzpegMve9EQ |
| **groupId** | `` | No | showDrafted boolean Show drafted Default value: true |
| **showDrafted** | `` | No |  |
...
async function executeRequest() {
  try {
    const response = await ghl.api.request('GET', 'https://services.leadconnectorhq.com/calendars/', {
...
unirest('GET', 'https://services.leadconnectorhq.com/calendars/')
  .headers({
    'Authorization': 'Bearer <YOUR_ACCESS_TOKEN>',
    'Version': '2021-07-28',
    'Content-Type': 'application/json'
...
$response = $client->request('GET', 'https://services.leadconnectorhq.com/calendars/', [
  'headers' => $headers,
  'body' => '{}'
]);
...
$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/calendars/' -Method 'GET' -Headers $headers -Body $body
