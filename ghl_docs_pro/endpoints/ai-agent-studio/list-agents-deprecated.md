...
**Method:** `GET` | **URL:** `https://services.leadconnectorhq.com/agent-studio/public-api/agents`
...
| :--- | :--- | :--- |
| `locationId` | ✅ | limit string required Example: 20 |
| `limit` | ✅ | offset string required Example: 0 |
| `offset` | ❌ | source string Example: api |
| `source` | ❌ |  |
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.agentStudio.getAgentsDeprecated({
...
```nodejs
	...
	var req = unirest('GET', 'https://services.leadconnectorhq.com/agent-studio/public-api/agents')
...
```python
	...
	conn.request("GET", "/agent-studio/public-api/agents", payload, headers)
...
```php
	...
	curl_setopt_array($curl, array(
	  ...
	  CURLOPT_URL => 'https://services.leadconnectorhq.com/agent-studio/public-api/agents',
...
```php
	...
	$request = new Request('GET', 'https://services.leadconnectorhq.com/agent-studio/public-api/agents', $headers);
...
```php
	...
	$request->setUrl('https://services.leadconnectorhq.com/agent-studio/public-api/agents');
...
```php
	...
	$request->setRequestUrl('https://services.leadconnectorhq.com/agent-studio/public-api/agents');
...
```java
	...
	HttpResponse<String> response = Unirest.get("https://services.leadconnectorhq.com/agent-studio/public-api/agents")
...
```ruby
	...
	url = URI("https://services.leadconnectorhq.com/agent-studio/public-api/agents")
...
```powershell
	...
	$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/agent-studio/public-api/agents' -Method 'GET' -Headers $headers
