...
**Method:** `POST` | **URL:** `https://services.leadconnectorhq.com/agent-studio/agent/versions/:versionId/publish`
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.agentStudio.promoteAndPublish({
...
```nodejs
	...
	var req = unirest('POST', 'https://services.leadconnectorhq.com/agent-studio/agent/versions/:versionId/publish')
...
```python
	...
	conn.request("POST", "/agent-studio/agent/versions/:versionId/publish", payload, headers)
...
```php
	...
	curl_setopt_array($curl, array(
	  ...
	  CURLOPT_URL => 'https://services.leadconnectorhq.com/agent-studio/agent/versions/:versionId/publish',
...
```php
	...
	$request = new Request('POST', 'https://services.leadconnectorhq.com/agent-studio/agent/versions/:versionId/publish', $headers, $body);
...
```php
	...
	$request->setUrl('https://services.leadconnectorhq.com/agent-studio/agent/versions/:versionId/publish');
...
```php
	...
	$request->setRequestUrl('https://services.leadconnectorhq.com/agent-studio/agent/versions/:versionId/publish');
...
```java
	...
	HttpResponse<String> response = Unirest.post("https://services.leadconnectorhq.com/agent-studio/agent/versions/:versionId/publish")
