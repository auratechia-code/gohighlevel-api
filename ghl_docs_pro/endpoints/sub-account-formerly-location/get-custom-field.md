...
**Method:** `GET` | **URL:** `https://services.leadconnectorhq.com/locations/:locationId/customFields/:id`
...
| :--- | :--- | :--- |
| `locationId` | ✅ | id string required Custom Field Id or Field Key (e.g. "contact.first_name" or "opportunity.pipeline_id") Examples: id field_key Custom Field ID Example: 00NhGCcN1tlO8ZHcu7Wb Custom Field Key Example: contact.first_name |
| `id` | ❌ |  |
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.locations.getCustomField({
...
```nodejs
	...
	var req = unirest('GET', 'https://services.leadconnectorhq.com/locations/:locationId/customFields/:id')
...
```python
	...
	conn.request("GET", "/locations/:locationId/customFields/:id", payload, headers)
...
```php
	...
	$request = new Request('GET', 'https://services.leadconnectorhq.com/locations/:locationId/customFields/:id', $headers);
...
```java
	...
	HttpResponse<String> response = Unirest.get("https://services.leadconnectorhq.com/locations/:locationId/customFields/:id")
...
```powershell
	...
	$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/locations/:locationId/customFields/:id' -Method 'GET' -Headers $headers
