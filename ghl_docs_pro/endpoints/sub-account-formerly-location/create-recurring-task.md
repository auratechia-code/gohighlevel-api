...
**Method:** `POST` | **URL:** `https://services.leadconnectorhq.com/locations/:locationId/recurring-tasks`
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.locations.createRecurringTask({
...
```nodejs
	...
	var req = unirest('POST', 'https://services.leadconnectorhq.com/locations/:locationId/recurring-tasks')
...
```python
	...
	conn.request("POST", "/locations/:locationId/recurring-tasks", payload, headers)
...
```php
	...
	curl_setopt_array($curl, array(
	  ...
	  CURLOPT_URL => 'https://services.leadconnectorhq.com/locations/:locationId/recurring-tasks',
...
```php
	...
	$request = new Request('POST', 'https://services.leadconnectorhq.com/locations/:locationId/recurring-tasks', $headers, $body);
...
```php
	...
	$request->setUrl('https://services.leadconnectorhq.com/locations/:locationId/recurring-tasks');
...
```php
	...
	$request->setRequestUrl('https://services.leadconnectorhq.com/locations/:locationId/recurring-tasks');
...
```java
	...
	HttpResponse<String> response = Unirest.post("https://services.leadconnectorhq.com/locations/:locationId/recurring-tasks")
