...
**Method:** `DELETE` | **URL:** `https://services.leadconnectorhq.com/locations/:locationId/recurring-tasks/:id`
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.locations.deleteRecurringTask({
...
```nodejs
	...
	var req = unirest('DELETE', 'https://services.leadconnectorhq.com/locations/:locationId/recurring-tasks/:id')
...
```python
	...
	conn.request("DELETE", "/locations/:locationId/recurring-tasks/:id", payload, headers)
...
```php
	...
	$request = new Request('DELETE', 'https://services.leadconnectorhq.com/locations/:locationId/recurring-tasks/:id', $headers);
...
```java
	...
	HttpResponse<String> response = Unirest.delete("https://services.leadconnectorhq.com/locations/:locationId/recurring-tasks/:id")
...
```powershell
	...
	$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/locations/:locationId/recurring-tasks/:id' -Method 'DELETE' -Headers $headers
