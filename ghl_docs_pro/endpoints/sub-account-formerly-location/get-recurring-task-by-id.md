...
**Method:** `GET` | **URL:** `https://services.leadconnectorhq.com/locations/:locationId/recurring-tasks/:id`
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.locations.getRecurringTaskById({
...
```nodejs
	...
	var req = unirest('GET', 'https://services.leadconnectorhq.com/locations/:locationId/recurring-tasks/:id')
...
```python
	...
	conn.request("GET", "/locations/:locationId/recurring-tasks/:id", payload, headers)
...
```php
	...
	$request = new Request('GET', 'https://services.leadconnectorhq.com/locations/:locationId/recurring-tasks/:id', $headers);
...
```java
	...
	HttpResponse<String> response = Unirest.get("https://services.leadconnectorhq.com/locations/:locationId/recurring-tasks/:id")
...
```powershell
	...
	$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/locations/:locationId/recurring-tasks/:id' -Method 'GET' -Headers $headers
