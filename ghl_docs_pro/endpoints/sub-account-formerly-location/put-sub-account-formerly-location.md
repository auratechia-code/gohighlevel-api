...
**Method:** `PUT` | **URL:** `https://services.leadconnectorhq.com/locations/:locationId`
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.locations.putLocation({
...
```nodejs
	...
	var req = unirest('PUT', 'https://services.leadconnectorhq.com/locations/:locationId')
...
```python
	...
	conn.request("PUT", "/locations/:locationId", payload, headers)
...
```php
	...
	$request = new Request('PUT', 'https://services.leadconnectorhq.com/locations/:locationId', $headers, $body);
...
```java
	...
	HttpResponse<String> response = Unirest.put("https://services.leadconnectorhq.com/locations/:locationId")
