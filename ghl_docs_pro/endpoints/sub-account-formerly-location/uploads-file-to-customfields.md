...
**Method:** `POST` | **URL:** `https://services.leadconnectorhq.com/locations/:locationId/customFields/upload`
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.locations.uploadFileCustomFields({
...
```nodejs
	...
	var req = unirest('POST', 'https://services.leadconnectorhq.com/locations/:locationId/customFields/upload')
...
```python
	...
	conn.request("POST", "/locations/:locationId/customFields/upload", payload, headers)
...
```php
	...
	curl_setopt_array($curl, array(
	  ...
	  CURLOPT_URL => 'https://services.leadconnectorhq.com/locations/:locationId/customFields/upload',
...
```php
	...
	$request = new Request('POST', 'https://services.leadconnectorhq.com/locations/:locationId/customFields/upload', $headers);
...
```php
	...
	$request->setUrl('https://services.leadconnectorhq.com/locations/:locationId/customFields/upload');
...
```php
	...
	$request->setRequestUrl('https://services.leadconnectorhq.com/locations/:locationId/customFields/upload');
...
```java
	...
	HttpResponse<String> response = Unirest.post("https://services.leadconnectorhq.com/locations/:locationId/customFields/upload")
...
```powershell
	...
	$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/locations/:locationId/customFields/upload' -Method 'POST' -Headers $headers
