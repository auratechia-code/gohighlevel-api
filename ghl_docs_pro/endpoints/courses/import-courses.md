...
**Method:** `POST` | **URL:** `https://services.leadconnectorhq.com/courses/courses-exporter/public/import`
...
```nodejs
	...
	var req = unirest('POST', 'https://services.leadconnectorhq.com/courses/courses-exporter/public/import')
...
```php
	...
	$request = new Request('POST', 'https://services.leadconnectorhq.com/courses/courses-exporter/public/import', $headers, $body);
...
```php
	...
	$request->setUrl('https://services.leadconnectorhq.com/courses/courses-exporter/public/import');
...
```php
	...
	$request->setRequestUrl('https://services.leadconnectorhq.com/courses/courses-exporter/public/import');
...
```java
	...
	HttpResponse<String> response = Unirest.post("https://services.leadconnectorhq.com/courses/courses-exporter/public/import")
