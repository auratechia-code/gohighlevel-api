...
**Method:** `GET` | **URL:** `https://services.leadconnectorhq.com/users/:userId`
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.users.getUser({
...
```nodejs
	...
	var req = unirest('GET', 'https://services.leadconnectorhq.com/users/:userId')
...
```python
	...
	conn.request("GET", "/users/:userId", payload, headers)
...
```php
	...
	$request = new Request('GET', 'https://services.leadconnectorhq.com/users/:userId', $headers);
...
```java
	...
	HttpResponse<String> response = Unirest.get("https://services.leadconnectorhq.com/users/:userId")
...
```powershell
	...
	$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/users/:userId' -Method 'GET' -Headers $headers
