...
**Method:** `PUT` | **URL:** `https://services.leadconnectorhq.com/objects/:key`
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.objects.updateCustomObject({
...
```nodejs
	...
	var req = unirest('PUT', 'https://services.leadconnectorhq.com/objects/:key')
...
```python
	...
	conn.request("PUT", "/objects/:key", payload, headers)
...
```php
	...
	$request = new Request('PUT', 'https://services.leadconnectorhq.com/objects/:key', $headers, $body);
...
```java
	...
	HttpResponse<String> response = Unirest.put("https://services.leadconnectorhq.com/objects/:key")
...
```powershell
	...
	$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/objects/:key' -Method 'PUT' -Headers $headers -Body $body
