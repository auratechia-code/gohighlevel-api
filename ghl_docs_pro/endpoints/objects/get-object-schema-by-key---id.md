...
**Method:** `GET` | **URL:** `https://services.leadconnectorhq.com/objects/:key`
...
| Name | Required | Description |
| :--- | :--- | :--- |
| `locationId` | ❌ | fetchProperties string Fetch Properties , Fetches all the standard / custom fields of the object when set to true Example: |
| `fetchProperties` | ❌ |  |
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.objects.getObjectSchemaByKey({
...
```nodejs
	...
	var req = unirest('GET', 'https://services.leadconnectorhq.com/objects/:key')
...
```python
	...
	conn.request("GET", "/objects/:key", payload, headers)
...
```php
	...
	curl_setopt_array($curl, array(
	  ...
	  CURLOPT_URL => 'https://services.leadconnectorhq.com/objects/:key',
...
```php
	...
	$request = new Request('GET', 'https://services.leadconnectorhq.com/objects/:key', $headers);
...
```php
	...
	$request->setUrl('https://services.leadconnectorhq.com/objects/:key');
...
```php
	...
	$request->setRequestUrl('https://services.leadconnectorhq.com/objects/:key');
...
```java
	...
	HttpResponse<String> response = Unirest.get("https://services.leadconnectorhq.com/objects/:key")
...
```ruby
	...
	url = URI("https://services.leadconnectorhq.com/objects/:key")
...
```powershell
	...
	$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/objects/:key' -Method 'GET' -Headers $headers
