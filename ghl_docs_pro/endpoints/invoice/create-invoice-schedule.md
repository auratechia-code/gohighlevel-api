...
**Method:** `POST` | **URL:** `https://services.leadconnectorhq.com/invoices/schedule`
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.invoices.createInvoiceSchedule({
...
```nodejs
	...
	var req = unirest('POST', 'https://services.leadconnectorhq.com/invoices/schedule')
...
```python
	...
	conn.request("POST", "/invoices/schedule", payload, headers)
...
```php
	...
	$request = new Request('POST', 'https://services.leadconnectorhq.com/invoices/schedule', $headers, $body);
...
```java
	...
	HttpResponse<String> response = Unirest.post("https://services.leadconnectorhq.com/invoices/schedule")
...
```powershell
	...
	$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/invoices/schedule' -Method 'POST' -Headers $headers -Body $body
