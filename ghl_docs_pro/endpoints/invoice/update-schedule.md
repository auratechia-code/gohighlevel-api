...
**Method:** `PUT` | **URL:** `https://services.leadconnectorhq.com/invoices/schedule/:scheduleId`
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.invoices.updateInvoiceSchedule({
...
```nodejs
	...
	var req = unirest('PUT', 'https://services.leadconnectorhq.com/invoices/schedule/:scheduleId')
...
```python
	...
	conn.request("PUT", "/invoices/schedule/:scheduleId", payload, headers)
...
```php
	...
	$request = new Request('PUT', 'https://services.leadconnectorhq.com/invoices/schedule/:scheduleId', $headers, $body);
...
```java
	...
	HttpResponse<String> response = Unirest.put("https://services.leadconnectorhq.com/invoices/schedule/:scheduleId")
