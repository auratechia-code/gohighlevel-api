...
**Method:** `DELETE` | **URL:** `https://services.leadconnectorhq.com/invoices/estimate/template/:templateId`
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.invoices.deleteEstimateTemplate({
...
```nodejs
	...
	var req = unirest('DELETE', 'https://services.leadconnectorhq.com/invoices/estimate/template/:templateId')
...
```python
	...
	conn.request("DELETE", "/invoices/estimate/template/:templateId", payload, headers)
...
```php
	...
	$request = new Request('DELETE', 'https://services.leadconnectorhq.com/invoices/estimate/template/:templateId', $headers, $body);
...
```java
	...
	HttpResponse<String> response = Unirest.delete("https://services.leadconnectorhq.com/invoices/estimate/template/:templateId")
...
```powershell
	...
	$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/invoices/estimate/template/:templateId' -Method 'DELETE' -Headers $headers -Body $body
