...
**Method:** `GET` | **URL:** `https://services.leadconnectorhq.com/invoices/:invoiceId`
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.invoices.getInvoice({
...
```nodejs
	...
	var req = unirest('GET', 'https://services.leadconnectorhq.com/invoices/:invoiceId')
...
```python
	...
	conn.request("GET", "/invoices/:invoiceId", payload, headers)
...
```php
	...
	$request = new Request('GET', 'https://services.leadconnectorhq.com/invoices/:invoiceId', $headers);
...
```php
	...
	$request->setUrl('https://services.leadconnectorhq.com/invoices/:invoiceId');
...
```php
	...
	$request->setRequestUrl('https://services.leadconnectorhq.com/invoices/:invoiceId');
...
```java
	...
	HttpResponse<String> response = Unirest.get("https://services.leadconnectorhq.com/invoices/:invoiceId")
...
```powershell
	...
	$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/invoices/:invoiceId' -Method 'GET' -Headers $headers
