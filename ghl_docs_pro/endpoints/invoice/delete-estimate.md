...
**Method:** `DELETE` | **URL:** `https://services.leadconnectorhq.com/invoices/estimate/:estimateId`
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.invoices.deleteEstimate({
...
```nodejs
	...
	var req = unirest('DELETE', 'https://services.leadconnectorhq.com/invoices/estimate/:estimateId')
...
```python
	...
	conn.request("DELETE", "/invoices/estimate/:estimateId", payload, headers)
...
```php
	...
	$request = new Request('DELETE', 'https://services.leadconnectorhq.com/invoices/estimate/:estimateId', $headers, $body);
...
```java
	...
	HttpResponse<String> response = Unirest.delete("https://services.leadconnectorhq.com/invoices/estimate/:estimateId")
...
```powershell
	...
	$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/invoices/estimate/:estimateId' -Method 'DELETE' -Headers $headers -Body $body
