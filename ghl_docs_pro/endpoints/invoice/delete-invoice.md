...
**Method:** `DELETE` | **URL:** `https://services.leadconnectorhq.com/invoices/:invoiceId`
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.invoices.deleteInvoice({
...
```nodejs
	...
	var req = unirest('DELETE', 'https://services.leadconnectorhq.com/invoices/:invoiceId')
...
```python
	...
	conn.request("DELETE", "/invoices/:invoiceId", payload, headers)
...
```php
	...
	$request = new Request('DELETE', 'https://services.leadconnectorhq.com/invoices/:invoiceId', $headers);
...
```java
	...
	HttpResponse<String> response = Unirest.delete("https://services.leadconnectorhq.com/invoices/:invoiceId")
...
```powershell
	...
	$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/invoices/:invoiceId' -Method 'DELETE' -Headers $headers
