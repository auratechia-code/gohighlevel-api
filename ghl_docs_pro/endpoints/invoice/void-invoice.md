...
**Method:** `POST` | **URL:** `https://services.leadconnectorhq.com/invoices/:invoiceId/void`
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.invoices.voidInvoice({
...
```nodejs
	...
	var req = unirest('POST', 'https://services.leadconnectorhq.com/invoices/:invoiceId/void')
...
```python
	...
	conn.request("POST", "/invoices/:invoiceId/void", payload, headers)
...
```php
	...
	$request = new Request('POST', 'https://services.leadconnectorhq.com/invoices/:invoiceId/void', $headers, $body);
...
```php
	...
	$request->setUrl('https://services.leadconnectorhq.com/invoices/:invoiceId/void');
...
```php
	...
	$request->setRequestUrl('https://services.leadconnectorhq.com/invoices/:invoiceId/void');
...
```java
	...
	HttpResponse<String> response = Unirest.post("https://services.leadconnectorhq.com/invoices/:invoiceId/void")
