...
**Method:** `PUT` | **URL:** `https://services.leadconnectorhq.com/invoices/template/:templateId`
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.invoices.updateInvoiceTemplate({
...
```nodejs
	...
	var req = unirest('PUT', 'https://services.leadconnectorhq.com/invoices/template/:templateId')
...
```python
	...
	conn.request("PUT", "/invoices/template/:templateId", payload, headers)
...
```php
	...
	$request = new Request('PUT', 'https://services.leadconnectorhq.com/invoices/template/:templateId', $headers, $body);
...
```java
	...
	HttpResponse<String> response = Unirest.put("https://services.leadconnectorhq.com/invoices/template/:templateId")
...
```powershell
	...
	$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/invoices/template/:templateId' -Method 'PUT' -Headers $headers -Body $body
