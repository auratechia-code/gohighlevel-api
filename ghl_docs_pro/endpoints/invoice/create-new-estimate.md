...
**Method:** `POST` | **URL:** `https://services.leadconnectorhq.com/invoices/estimate`
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.invoices.createNewEstimate({
...
```nodejs
	...
	var req = unirest('POST', 'https://services.leadconnectorhq.com/invoices/estimate')
...
```python
	...
	conn.request("POST", "/invoices/estimate", payload, headers)
...
```php
	...
	curl_setopt_array($curl, array(
	  ...
	  CURLOPT_URL => 'https://services.leadconnectorhq.com/invoices/estimate',
...
```php
	...
	$request = new Request('POST', 'https://services.leadconnectorhq.com/invoices/estimate', $headers, $body);
...
```php
	...
	$request->setUrl('https://services.leadconnectorhq.com/invoices/estimate');
...
```php
	...
	$request->setRequestUrl('https://services.leadconnectorhq.com/invoices/estimate');
...
```java
	...
	HttpResponse<String> response = Unirest.post("https://services.leadconnectorhq.com/invoices/estimate")
