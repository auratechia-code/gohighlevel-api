...
**Method:** `POST` | **URL:** `https://services.leadconnectorhq.com/invoices/:invoiceId/send`
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.invoices.sendInvoice({
...
```nodejs
	...
	var req = unirest('POST', 'https://services.leadconnectorhq.com/invoices/:invoiceId/send')
...
```python
	...
	conn.request("POST", "/invoices/:invoiceId/send", payload, headers)
...
```php
	...
	$request = new Request('POST', 'https://services.leadconnectorhq.com/invoices/:invoiceId/send', $headers, $body);
...
```php
	...
	$request->setUrl('https://services.leadconnectorhq.com/invoices/:invoiceId/send');
...
```php
	...
	$request->setRequestUrl('https://services.leadconnectorhq.com/invoices/:invoiceId/send');
...
```java
	...
	HttpResponse<String> response = Unirest.post("https://services.leadconnectorhq.com/invoices/:invoiceId/send")
...
```ruby
	...
	url = URI("https://services.leadconnectorhq.com/invoices/:invoiceId/send")
...
```powershell
	...
	$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/invoices/:invoiceId/send' -Method 'POST' -Headers $headers -Body $body
