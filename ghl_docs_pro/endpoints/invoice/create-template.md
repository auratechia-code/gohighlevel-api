...
**Method:** `POST` | **URL:** `https://services.leadconnectorhq.com/invoices/template`
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.invoices.createInvoiceTemplate({
...
```nodejs
	...
	var req = unirest('POST', 'https://services.leadconnectorhq.com/invoices/template')
...
```python
	...
	conn.request("POST", "/invoices/template", payload, headers)
...
```php
	...
	curl_setopt_array($curl, array(
	  ...
	  CURLOPT_URL => 'https://services.leadconnectorhq.com/invoices/template',
...
```php
	...
	$request = new Request('POST', 'https://services.leadconnectorhq.com/invoices/template', $headers, $body);
...
```php
	...
	$request->setUrl('https://services.leadconnectorhq.com/invoices/template');
...
```php
	...
	$request->setRequestUrl('https://services.leadconnectorhq.com/invoices/template');
...
```java
	...
	HttpResponse<String> response = Unirest.post("https://services.leadconnectorhq.com/invoices/template")
