...
**Method:** `POST` | **URL:** `https://services.leadconnectorhq.com/invoices/schedule/:scheduleId/updateAndSchedule`
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.invoices.updateAndScheduleInvoiceSchedule({
...
```nodejs
	...
	var req = unirest('POST', 'https://services.leadconnectorhq.com/invoices/schedule/:scheduleId/updateAndSchedule')
...
```python
	...
	conn.request("POST", "/invoices/schedule/:scheduleId/updateAndSchedule", payload, headers)
...
```php
	...
	curl_setopt_array($curl, array(
	  ...
	  CURLOPT_URL => 'https://services.leadconnectorhq.com/invoices/schedule/:scheduleId/updateAndSchedule',
...
```php
	...
	$request = new Request('POST', 'https://services.leadconnectorhq.com/invoices/schedule/:scheduleId/updateAndSchedule', $headers);
...
```php
	...
	$request->setUrl('https://services.leadconnectorhq.com/invoices/schedule/:scheduleId/updateAndSchedule');
...
```php
	...
	$request->setRequestUrl('https://services.leadconnectorhq.com/invoices/schedule/:scheduleId/updateAndSchedule');
...
```java
	...
	HttpResponse<String> response = Unirest.post("https://services.leadconnectorhq.com/invoices/schedule/:scheduleId/updateAndSchedule")
...
```ruby
	...
	url = URI("https://services.leadconnectorhq.com/invoices/schedule/:scheduleId/updateAndSchedule")
...
```powershell
	...
	$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/invoices/schedule/:scheduleId/updateAndSchedule' -Method 'POST' -Headers $headers
