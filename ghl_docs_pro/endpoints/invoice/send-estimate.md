...
**Method:** `POST` | **URL:** `https://services.leadconnectorhq.com/invoices/estimate/:estimateId/send`
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.invoices.sendEstimate({
...
```nodejs
	...
	var req = unirest('POST', 'https://services.leadconnectorhq.com/invoices/estimate/:estimateId/send')
...
```python
	...
	conn.request("POST", "/invoices/estimate/:estimateId/send", payload, headers)
...
```php
	...
	curl_setopt_array($curl, array(
	  ...
	  CURLOPT_URL => 'https://services.leadconnectorhq.com/invoices/estimate/:estimateId/send',
...
```php
	...
	$request = new Request('POST', 'https://services.leadconnectorhq.com/invoices/estimate/:estimateId/send', $headers, $body);
...
```php
	...
	$request->setUrl('https://services.leadconnectorhq.com/invoices/estimate/:estimateId/send');
...
```php
	...
	$request->setRequestUrl('https://services.leadconnectorhq.com/invoices/estimate/:estimateId/send');
...
```java
	...
	HttpResponse<String> response = Unirest.post("https://services.leadconnectorhq.com/invoices/estimate/:estimateId/send")
...
```ruby
	...
	url = URI("https://services.leadconnectorhq.com/invoices/estimate/:estimateId/send")
...
```powershell
	...
	$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/invoices/estimate/:estimateId/send' -Method 'POST' -Headers $headers -Body $body
