...
**Method:** `GET` | **URL:** `https://services.leadconnectorhq.com/invoices/settings`
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.invoices.getInvoiceSettings({
...
```nodejs
	...
	var req = unirest('GET', 'https://services.leadconnectorhq.com/invoices/settings')
...
```python
	...
	conn.request("GET", "/invoices/settings", payload, headers)
...
```php
	...
	curl_setopt_array($curl, array(
	  ...
	  CURLOPT_URL => 'https://services.leadconnectorhq.com/invoices/settings',
...
```php
	...
	$request = new Request('GET', 'https://services.leadconnectorhq.com/invoices/settings', $headers);
...
```php
	...
	$request->setUrl('https://services.leadconnectorhq.com/invoices/settings');
...
```php
	...
	$request->setRequestUrl('https://services.leadconnectorhq.com/invoices/settings');
...
```java
	...
	HttpResponse<String> response = Unirest.get("https://services.leadconnectorhq.com/invoices/settings")
...
```powershell
	...
	$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/invoices/settings' -Method 'GET' -Headers $headers
