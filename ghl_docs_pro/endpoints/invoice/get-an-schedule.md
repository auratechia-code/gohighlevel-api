...
**Method:** `GET` | **URL:** `https://services.leadconnectorhq.com/invoices/schedule/:scheduleId`
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.invoices.getInvoiceSchedule({
...
```nodejs
	...
	var req = unirest('GET', 'https://services.leadconnectorhq.com/invoices/schedule/:scheduleId')
...
```python
	...
	conn.request("GET", "/invoices/schedule/:scheduleId", payload, headers)
...
```php
	...
	$request = new Request('GET', 'https://services.leadconnectorhq.com/invoices/schedule/:scheduleId', $headers);
...
```java
	...
	HttpResponse<String> response = Unirest.get("https://services.leadconnectorhq.com/invoices/schedule/:scheduleId")
...
```powershell
	...
	$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/invoices/schedule/:scheduleId' -Method 'GET' -Headers $headers
