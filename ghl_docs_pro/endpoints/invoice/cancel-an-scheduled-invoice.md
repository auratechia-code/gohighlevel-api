...
**Method:** `POST` | **URL:** `https://services.leadconnectorhq.com/invoices/schedule/:scheduleId/cancel`
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.invoices.cancelInvoiceSchedule({
...
```nodejs
	...
	var req = unirest('POST', 'https://services.leadconnectorhq.com/invoices/schedule/:scheduleId/cancel')
...
```python
	...
	conn.request("POST", "/invoices/schedule/:scheduleId/cancel", payload, headers)
...
```php
	...
	curl_setopt_array($curl, array(
	  ...
	  CURLOPT_URL => 'https://services.leadconnectorhq.com/invoices/schedule/:scheduleId/cancel',
...
```php
	...
	$request = new Request('POST', 'https://services.leadconnectorhq.com/invoices/schedule/:scheduleId/cancel', $headers, $body);
...
```php
	...
	$request->setUrl('https://services.leadconnectorhq.com/invoices/schedule/:scheduleId/cancel');
...
```php
	...
	$request->setRequestUrl('https://services.leadconnectorhq.com/invoices/schedule/:scheduleId/cancel');
...
```java
	...
	HttpResponse<String> response = Unirest.post("https://services.leadconnectorhq.com/invoices/schedule/:scheduleId/cancel")
