...
**Method:** `POST` | **URL:** `https://services.leadconnectorhq.com/invoices/:invoiceId/record-payment`
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.invoices.recordInvoice({
...
```nodejs
	...
	var req = unirest('POST', 'https://services.leadconnectorhq.com/invoices/:invoiceId/record-payment')
...
```python
	...
	conn.request("POST", "/invoices/:invoiceId/record-payment", payload, headers)
...
```php
	...
	curl_setopt_array($curl, array(
	  ...
	  CURLOPT_URL => 'https://services.leadconnectorhq.com/invoices/:invoiceId/record-payment',
...
```php
	...
	$request = new Request('POST', 'https://services.leadconnectorhq.com/invoices/:invoiceId/record-payment', $headers, $body);
...
```php
	...
	$request->setUrl('https://services.leadconnectorhq.com/invoices/:invoiceId/record-payment');
...
```php
	...
	$request->setRequestUrl('https://services.leadconnectorhq.com/invoices/:invoiceId/record-payment');
...
```java
	...
	HttpResponse<String> response = Unirest.post("https://services.leadconnectorhq.com/invoices/:invoiceId/record-payment")
...
```ruby
	...
	url = URI("https://services.leadconnectorhq.com/invoices/:invoiceId/record-payment")
...
```powershell
	...
	$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/invoices/:invoiceId/record-payment' -Method 'POST' -Headers $headers -Body $body
