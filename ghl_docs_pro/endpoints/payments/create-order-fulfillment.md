...
**Method:** `POST` | **URL:** `https://services.leadconnectorhq.com/payments/orders/:orderId/fulfillments`
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.payments.createOrderFulfillment({
...
```nodejs
	...
	var req = unirest('POST', 'https://services.leadconnectorhq.com/payments/orders/:orderId/fulfillments')
...
```python
	...
	conn.request("POST", "/payments/orders/:orderId/fulfillments", payload, headers)
...
```php
	...
	$request = new Request('POST', 'https://services.leadconnectorhq.com/payments/orders/:orderId/fulfillments', $headers, $body);
...
```java
	...
	HttpResponse<String> response = Unirest.post("https://services.leadconnectorhq.com/payments/orders/:orderId/fulfillments")
