...
**Method:** `POST` | **URL:** `https://services.leadconnectorhq.com/payments/custom-provider/provider`
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.payments.createIntegration({
...
```nodejs
	...
	var req = unirest('POST', 'https://services.leadconnectorhq.com/payments/custom-provider/provider')
...
```python
	...
	conn.request("POST", "/payments/custom-provider/provider", payload, headers)
...
```php
	...
	curl_setopt_array($curl, array(
	  ...
	  CURLOPT_URL => 'https://services.leadconnectorhq.com/payments/custom-provider/provider',
...
```php
	...
	$request = new Request('POST', 'https://services.leadconnectorhq.com/payments/custom-provider/provider', $headers, $body);
...
```php
	...
	$request->setUrl('https://services.leadconnectorhq.com/payments/custom-provider/provider');
...
```php
	...
	$request->setRequestUrl('https://services.leadconnectorhq.com/payments/custom-provider/provider');
...
```java
	...
	HttpResponse<String> response = Unirest.post("https://services.leadconnectorhq.com/payments/custom-provider/provider")
...
```ruby
	...
	url = URI("https://services.leadconnectorhq.com/payments/custom-provider/provider")
...
```powershell
	...
	$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/payments/custom-provider/provider' -Method 'POST' -Headers $headers -Body $body
