...
**Method:** `PUT` | **URL:** `https://services.leadconnectorhq.com/payments/coupon`
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.payments.updateCoupon({
...
```nodejs
	...
	var req = unirest('PUT', 'https://services.leadconnectorhq.com/payments/coupon')
...
```python
	...
	conn.request("PUT", "/payments/coupon", payload, headers)
...
```php
	...
	$request = new Request('PUT', 'https://services.leadconnectorhq.com/payments/coupon', $headers, $body);
...
```java
	...
	HttpResponse<String> response = Unirest.put("https://services.leadconnectorhq.com/payments/coupon")
...
```powershell
	...
	$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/payments/coupon' -Method 'PUT' -Headers $headers -Body $body
