...
**Method:** `GET` | **URL:** `https://services.leadconnectorhq.com/payments/custom-provider/connect`
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.payments.fetchConfig({
...
```nodejs
	...
	var req = unirest('GET', 'https://services.leadconnectorhq.com/payments/custom-provider/connect')
...
```python
	...
	conn.request("GET", "/payments/custom-provider/connect", payload, headers)
...
```php
	...
	$request = new Request('GET', 'https://services.leadconnectorhq.com/payments/custom-provider/connect', $headers);
...
```java
	...
	HttpResponse<String> response = Unirest.get("https://services.leadconnectorhq.com/payments/custom-provider/connect")
...
```powershell
	...
	$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/payments/custom-provider/connect' -Method 'GET' -Headers $headers
