...
**Method:** `GET` | **URL:** `https://services.leadconnectorhq.com/payments/coupon`
...
| `altType` | ✅ | id string required Coupon id Example: 6241712be68f7a98102ba272 |
| `id` | ✅ | code string required Coupon code Example: DEAL50 |
| `code` | ❌ |  |
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.payments.getCoupon({
...
```nodejs
	...
	var req = unirest('GET', 'https://services.leadconnectorhq.com/payments/coupon')
...
```python
	...
	conn.request("GET", "/payments/coupon", payload, headers)
...
```php
	...
	$request = new Request('GET', 'https://services.leadconnectorhq.com/payments/coupon', $headers);
...
```java
	...
	HttpResponse<String> response = Unirest.get("https://services.leadconnectorhq.com/payments/coupon")
...
```powershell
	...
	$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/payments/coupon' -Method 'GET' -Headers $headers
