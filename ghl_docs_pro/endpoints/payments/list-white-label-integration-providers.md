...
**Method:** `GET` | **URL:** `https://services.leadconnectorhq.com/payments/integrations/provider/whitelabel`
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.payments.listIntegrationProviders({
...
```nodejs
	...
	var req = unirest('GET', 'https://services.leadconnectorhq.com/payments/integrations/provider/whitelabel')
...
```python
	...
	conn.request("GET", "/payments/integrations/provider/whitelabel", payload, headers)
...
```php
	...
	$request = new Request('GET', 'https://services.leadconnectorhq.com/payments/integrations/provider/whitelabel', $headers);
...
```java
	...
	HttpResponse<String> response = Unirest.get("https://services.leadconnectorhq.com/payments/integrations/provider/whitelabel")
...
```powershell
	...
	$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/payments/integrations/provider/whitelabel' -Method 'GET' -Headers $headers
