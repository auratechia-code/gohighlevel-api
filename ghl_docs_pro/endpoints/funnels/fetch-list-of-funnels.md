...
**Method:** `GET` | **URL:** `https://services.leadconnectorhq.com/funnels/funnel/list`
...
| `category` | ❌ | offset string |
| `offset` | ❌ | limit string |
| `limit` | ❌ | parentId string |
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.funnels.getFunnels({
...
```nodejs
	...
	var req = unirest('GET', 'https://services.leadconnectorhq.com/funnels/funnel/list')
...
```python
	...
	conn.request("GET", "/funnels/funnel/list", payload, headers)
...
```php
	...
	curl_setopt_array($curl, array(
	  ...
	  CURLOPT_URL => 'https://services.leadconnectorhq.com/funnels/funnel/list',
...
```php
	...
	$request = new Request('GET', 'https://services.leadconnectorhq.com/funnels/funnel/list', $headers);
...
```php
	...
	$request->setUrl('https://services.leadconnectorhq.com/funnels/funnel/list');
...
```php
	...
	$request->setRequestUrl('https://services.leadconnectorhq.com/funnels/funnel/list');
...
```java
	...
	HttpResponse<String> response = Unirest.get("https://services.leadconnectorhq.com/funnels/funnel/list")
...
```powershell
	...
	$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/funnels/funnel/list' -Method 'GET' -Headers $headers
