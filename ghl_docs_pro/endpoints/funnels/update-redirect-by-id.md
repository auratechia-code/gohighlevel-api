...
**Method:** `PATCH` | **URL:** `https://services.leadconnectorhq.com/funnels/lookup/redirect/:id`
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.funnels.updateRedirectById({
...
```nodejs
	...
	var req = unirest('PATCH', 'https://services.leadconnectorhq.com/funnels/lookup/redirect/:id')
...
```python
	...
	conn.request("PATCH", "/funnels/lookup/redirect/:id", payload, headers)
...
```php
	...
	$request = new Request('PATCH', 'https://services.leadconnectorhq.com/funnels/lookup/redirect/:id', $headers, $body);
...
```java
	...
	HttpResponse<String> response = Unirest.patch("https://services.leadconnectorhq.com/funnels/lookup/redirect/:id")
