...
**Method:** `GET` | **URL:** `https://services.leadconnectorhq.com/businesses/:businessId`
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.businesses.getBusiness({
...
```nodejs
	...
	var req = unirest('GET', 'https://services.leadconnectorhq.com/businesses/:businessId')
...
```python
	...
	conn.request("GET", "/businesses/:businessId", payload, headers)
...
```php
	...
	$request = new Request('GET', 'https://services.leadconnectorhq.com/businesses/:businessId', $headers);
...
```java
	...
	HttpResponse<String> response = Unirest.get("https://services.leadconnectorhq.com/businesses/:businessId")
...
```powershell
	...
	$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/businesses/:businessId' -Method 'GET' -Headers $headers
