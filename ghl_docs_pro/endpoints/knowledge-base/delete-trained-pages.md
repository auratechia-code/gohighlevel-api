...
**Method:** `DELETE` | **URL:** `https://services.leadconnectorhq.com/knowledge-bases/crawler`
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.knowledgeBase.deleteTrainedUrlsForKnowledgeBase({
...
```nodejs
	...
	var req = unirest('DELETE', 'https://services.leadconnectorhq.com/knowledge-bases/crawler')
...
```python
	...
	conn.request("DELETE", "/knowledge-bases/crawler", payload, headers)
...
```php
	...
	$request = new Request('DELETE', 'https://services.leadconnectorhq.com/knowledge-bases/crawler', $headers, $body);
...
```java
	...
	HttpResponse<String> response = Unirest.delete("https://services.leadconnectorhq.com/knowledge-bases/crawler")
...
```powershell
	...
	$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/knowledge-bases/crawler' -Method 'DELETE' -Headers $headers -Body $body
