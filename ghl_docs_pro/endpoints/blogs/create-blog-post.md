...
**Method:** `POST` | **URL:** `https://services.leadconnectorhq.com/blogs/posts`
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.blogs.createBlogPost({
...
```nodejs
	...
	var req = unirest('POST', 'https://services.leadconnectorhq.com/blogs/posts')
...
```python
	...
	conn.request("POST", "/blogs/posts", payload, headers)
...
```php
	...
	$request = new Request('POST', 'https://services.leadconnectorhq.com/blogs/posts', $headers, $body);
...
```php
	...
	$request->setUrl('https://services.leadconnectorhq.com/blogs/posts');
...
```php
	...
	$request->setRequestUrl('https://services.leadconnectorhq.com/blogs/posts');
...
```java
	...
	HttpResponse<String> response = Unirest.post("https://services.leadconnectorhq.com/blogs/posts")
...
```ruby
	...
	url = URI("https://services.leadconnectorhq.com/blogs/posts")
...
```powershell
	...
	$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/blogs/posts' -Method 'POST' -Headers $headers -Body $body
