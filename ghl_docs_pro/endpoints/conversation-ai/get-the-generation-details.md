...
**Method:** `GET` | **URL:** `https://services.leadconnectorhq.com/conversation-ai/generations`
...
| :--- | :--- | :--- |
| `messageId` | ✅ | source string required Possible values: [ conversation , workflow ] Example: conversation |
| `source` | ❌ |  |
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.conversationAi.getGenerationDetails({
...
```nodejs
	...
	var req = unirest('GET', 'https://services.leadconnectorhq.com/conversation-ai/generations')
...
```python
	...
	conn.request("GET", "/conversation-ai/generations", payload, headers)
...
```php
	...
	curl_setopt_array($curl, array(
	  ...
	  CURLOPT_URL => 'https://services.leadconnectorhq.com/conversation-ai/generations',
...
```php
	...
	$request = new Request('GET', 'https://services.leadconnectorhq.com/conversation-ai/generations', $headers);
...
```php
	...
	$request->setUrl('https://services.leadconnectorhq.com/conversation-ai/generations');
...
```php
	...
	$request->setRequestUrl('https://services.leadconnectorhq.com/conversation-ai/generations');
...
```java
	...
	HttpResponse<String> response = Unirest.get("https://services.leadconnectorhq.com/conversation-ai/generations")
...
```ruby
	...
	url = URI("https://services.leadconnectorhq.com/conversation-ai/generations")
...
```powershell
	...
	$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/conversation-ai/generations' -Method 'GET' -Headers $headers
