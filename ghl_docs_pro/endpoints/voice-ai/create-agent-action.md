...
**Method:** `POST` | **URL:** `https://services.leadconnectorhq.com/voice-ai/actions`
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.voiceAi.createAction({
...
```nodejs
	...
	var req = unirest('POST', 'https://services.leadconnectorhq.com/voice-ai/actions')
...
```python
	...
	conn.request("POST", "/voice-ai/actions", payload, headers)
...
```php
	...
	curl_setopt_array($curl, array(
	  ...
	  CURLOPT_URL => 'https://services.leadconnectorhq.com/voice-ai/actions',
...
```php
	...
	$request = new Request('POST', 'https://services.leadconnectorhq.com/voice-ai/actions', $headers, $body);
...
```php
	...
	$request->setUrl('https://services.leadconnectorhq.com/voice-ai/actions');
...
```php
	...
	$request->setRequestUrl('https://services.leadconnectorhq.com/voice-ai/actions');
...
```java
	...
	HttpResponse<String> response = Unirest.post("https://services.leadconnectorhq.com/voice-ai/actions")
