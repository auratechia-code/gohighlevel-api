...
**Method:** `GET` | **URL:** `https://services.leadconnectorhq.com/voice-ai/dashboard/call-logs/:callId`
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.voiceAi.getCallLog({
...
```nodejs
	...
	var req = unirest('GET', 'https://services.leadconnectorhq.com/voice-ai/dashboard/call-logs/:callId')
...
```python
	...
	conn.request("GET", "/voice-ai/dashboard/call-logs/:callId", payload, headers)
...
```php
	...
	curl_setopt_array($curl, array(
	  ...
	  CURLOPT_URL => 'https://services.leadconnectorhq.com/voice-ai/dashboard/call-logs/:callId',
...
```php
	...
	$request = new Request('GET', 'https://services.leadconnectorhq.com/voice-ai/dashboard/call-logs/:callId', $headers);
...
```php
	...
	$request->setUrl('https://services.leadconnectorhq.com/voice-ai/dashboard/call-logs/:callId');
...
```php
	...
	$request->setRequestUrl('https://services.leadconnectorhq.com/voice-ai/dashboard/call-logs/:callId');
...
```java
	...
	HttpResponse<String> response = Unirest.get("https://services.leadconnectorhq.com/voice-ai/dashboard/call-logs/:callId")
...
```powershell
	...
	$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/voice-ai/dashboard/call-logs/:callId' -Method 'GET' -Headers $headers
