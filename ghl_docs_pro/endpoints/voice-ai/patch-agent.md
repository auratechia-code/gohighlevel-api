...
**Method:** `PATCH` | **URL:** `https://services.leadconnectorhq.com/voice-ai/agents/:agentId`
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.voiceAi.patchAgent({
...
```nodejs
	...
	var req = unirest('PATCH', 'https://services.leadconnectorhq.com/voice-ai/agents/:agentId')
...
```python
	...
	conn.request("PATCH", "/voice-ai/agents/:agentId", payload, headers)
...
```php
	...
	$request = new Request('PATCH', 'https://services.leadconnectorhq.com/voice-ai/agents/:agentId', $headers, $body);
...
```java
	...
	HttpResponse<String> response = Unirest.patch("https://services.leadconnectorhq.com/voice-ai/agents/:agentId")
