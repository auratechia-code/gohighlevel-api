...
**Method:** `POST` | **URL:** `https://services.leadconnectorhq.com/products/collections`
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.products.createProductCollection({
...
```nodejs
	...
	var req = unirest('POST', 'https://services.leadconnectorhq.com/products/collections')
...
```python
	...
	conn.request("POST", "/products/collections", payload, headers)
...
```php
	...
	$request = new Request('POST', 'https://services.leadconnectorhq.com/products/collections', $headers, $body);
...
```java
	...
	HttpResponse<String> response = Unirest.post("https://services.leadconnectorhq.com/products/collections")
