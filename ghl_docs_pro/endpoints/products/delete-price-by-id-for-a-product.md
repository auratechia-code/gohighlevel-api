...
**Method:** `DELETE` | **URL:** `https://services.leadconnectorhq.com/products/:productId/price/:priceId`
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.products.deletePriceByIdForProduct({
...
```nodejs
	...
	var req = unirest('DELETE', 'https://services.leadconnectorhq.com/products/:productId/price/:priceId')
...
```python
	...
	conn.request("DELETE", "/products/:productId/price/:priceId", payload, headers)
...
```php
	...
	$request = new Request('DELETE', 'https://services.leadconnectorhq.com/products/:productId/price/:priceId', $headers);
...
```java
	...
	HttpResponse<String> response = Unirest.delete("https://services.leadconnectorhq.com/products/:productId/price/:priceId")
...
```powershell
	...
	$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/products/:productId/price/:priceId' -Method 'DELETE' -Headers $headers
