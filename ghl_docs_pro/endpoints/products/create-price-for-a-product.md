...
**Method:** `POST` | **URL:** `https://services.leadconnectorhq.com/products/:productId/price`
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.products.createPriceForProduct({
...
```nodejs
	...
	var req = unirest('POST', 'https://services.leadconnectorhq.com/products/:productId/price')
...
```python
	...
	conn.request("POST", "/products/:productId/price", payload, headers)
...
```php
	...
	$request = new Request('POST', 'https://services.leadconnectorhq.com/products/:productId/price', $headers, $body);
...
```java
	...
	HttpResponse<String> response = Unirest.post("https://services.leadconnectorhq.com/products/:productId/price")
