...
**Method:** `DELETE` | **URL:** `https://services.leadconnectorhq.com/products/:productId`
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.products.deleteProductById({
...
```nodejs
	...
	var req = unirest('DELETE', 'https://services.leadconnectorhq.com/products/:productId')
...
```python
	...
	conn.request("DELETE", "/products/:productId", payload, headers)
...
```php
	...
	$request = new Request('DELETE', 'https://services.leadconnectorhq.com/products/:productId', $headers);
...
```java
	...
	HttpResponse<String> response = Unirest.delete("https://services.leadconnectorhq.com/products/:productId")
...
```powershell
	...
	$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/products/:productId' -Method 'DELETE' -Headers $headers
