...
**Method:** `POST` | **URL:** `https://services.leadconnectorhq.com/products/`
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.products.createProduct({
...
```nodejs
	...
	var req = unirest('POST', 'https://services.leadconnectorhq.com/products/')
...
```php
	...
	$request = new Request('POST', 'https://services.leadconnectorhq.com/products/', $headers, $body);
...
```java
	...
	HttpResponse<String> response = Unirest.post("https://services.leadconnectorhq.com/products/")
...
```powershell
	...
	$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/products/' -Method 'POST' -Headers $headers -Body $body
