...
**Method:** `POST` | **URL:** `https://services.leadconnectorhq.com/proposals/document/send`
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.proposals.sendDocumentsContracts({
...
```nodejs
	...
	var req = unirest('POST', 'https://services.leadconnectorhq.com/proposals/document/send')
...
```python
	...
	conn.request("POST", "/proposals/document/send", payload, headers)
...
```php
	...
	curl_setopt_array($curl, array(
	  ...
	  CURLOPT_URL => 'https://services.leadconnectorhq.com/proposals/document/send',
...
```php
	...
	$request = new Request('POST', 'https://services.leadconnectorhq.com/proposals/document/send', $headers, $body);
...
```php
	...
	$request->setUrl('https://services.leadconnectorhq.com/proposals/document/send');
...
```php
	...
	$request->setRequestUrl('https://services.leadconnectorhq.com/proposals/document/send');
...
```java
	...
	HttpResponse<String> response = Unirest.post("https://services.leadconnectorhq.com/proposals/document/send")
