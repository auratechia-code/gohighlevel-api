...
**Method:** `GET` | **URL:** `https://services.leadconnectorhq.com/calendars/:calendarId`
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.calendars.getCalendar({
...
```nodejs
	...
	var req = unirest('GET', 'https://services.leadconnectorhq.com/calendars/:calendarId')
...
```python
	...
	conn.request("GET", "/calendars/:calendarId", payload, headers)
...
```php
	...
	$request = new Request('GET', 'https://services.leadconnectorhq.com/calendars/:calendarId', $headers);
...
```java
	...
	HttpResponse<String> response = Unirest.get("https://services.leadconnectorhq.com/calendars/:calendarId")
...
```powershell
	...
	$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/calendars/:calendarId' -Method 'GET' -Headers $headers
