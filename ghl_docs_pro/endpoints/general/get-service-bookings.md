...
**Method:** `GET` | **URL:** `https://services.leadconnectorhq.com/calendars/services/bookings`
...
| :--- | :--- | :--- |
| `locationId` | ✅ | startTime string required Start Time (timestamp in milliseconds as string) Example: 1704110400000 |
| `startTime` | ✅ | endTime string required End Time (timestamp in milliseconds as string) Example: 1704114000000 |
| `endTime` | ❌ | timezone string Timezone Example: America/New_York |
| `timezone` | ❌ | serviceLocationId string Service Location ID Example: 65e5f6dfacf123513228d384 |
| `serviceLocationId` | ❌ |  |
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.calendars.getServiceBookings({
...
```nodejs
	...
	var req = unirest('GET', 'https://services.leadconnectorhq.com/calendars/services/bookings')
...
```python
	...
	conn.request("GET", "/calendars/services/bookings", payload, headers)
...
```php
	...
	$request = new Request('GET', 'https://services.leadconnectorhq.com/calendars/services/bookings', $headers);
...
```java
	...
	HttpResponse<String> response = Unirest.get("https://services.leadconnectorhq.com/calendars/services/bookings")
...
```powershell
	...
	$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/calendars/services/bookings' -Method 'GET' -Headers $headers
