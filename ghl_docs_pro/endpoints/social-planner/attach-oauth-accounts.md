...
**Method:** `POST` | **URL:** `https://services.leadconnectorhq.com/social-media-posting/oauth/:locationId/:platform/accounts/:accountId`
...
| :--- | :--- | :--- |
| `locationId` | ✅ | platform string required Possible values: [ google , facebook , instagram , linkedin , tiktok , youtube , pinterest ] Platform Example: facebook |
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.socialPlanner.attachOauthAccounts({
...
```nodejs
	...
	var req = unirest('POST', 'https://services.leadconnectorhq.com/social-media-posting/oauth/:locationId/:platform/accounts/:accountId')
...
```python
	...
	conn.request("POST", "/social-media-posting/oauth/:locationId/:platform/accounts/:accountId", payload, headers)
...
```php
	...
	$request = new Request('POST', 'https://services.leadconnectorhq.com/social-media-posting/oauth/:locationId/:platform/accounts/:accountId', $headers, $body);
...
```java
	...
	HttpResponse<String> response = Unirest.post("https://services.leadconnectorhq.com/social-media-posting/oauth/:locationId/:platform/accounts/:accountId")
