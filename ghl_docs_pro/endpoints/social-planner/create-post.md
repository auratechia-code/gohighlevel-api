...
**Method:** `POST` | **URL:** `https://services.leadconnectorhq.com/social-media-posting/:locationId/posts`
...
```json
{  "success": true,  "statusCode": 201,  "message": "Created Post",  "results": {    "post": {      "_id": "61bb16833b3f2791f9715be2",      "locationId": "ve9EPM428h8vShlRW1KT",      "status": "published"    }  }}
```
</details>
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.socialPlanner.createPost({
...
```nodejs
	...
	var req = unirest('POST', 'https://services.leadconnectorhq.com/social-media-posting/:locationId/posts')
...
```python
	...
	conn.request("POST", "/social-media-posting/:locationId/posts", payload, headers)
...
```php
	...
	curl_setopt_array($curl, array(
	  ...
	  CURLOPT_URL => 'https://services.leadconnectorhq.com/social-media-posting/:locationId/posts',
...
```php
	...
	$request = new Request('POST', 'https://services.leadconnectorhq.com/social-media-posting/:locationId/posts', $headers, $body);
...
```php
	...
	$request->setUrl('https://services.leadconnectorhq.com/social-media-posting/:locationId/posts');
...
```php
	...
	$request->setRequestUrl('https://services.leadconnectorhq.com/social-media-posting/:locationId/posts');
...
```java
	...
	HttpResponse<String> response = Unirest.post("https://services.leadconnectorhq.com/social-media-posting/:locationId/posts")
...
```ruby
	...
	url = URI("https://services.leadconnectorhq.com/social-media-posting/:locationId/posts")
...
```powershell
	...
	$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/social-media-posting/:locationId/posts' -Method 'POST' -Headers $headers -Body $body
