...
**Method:** `GET` | **URL:** `https://services.leadconnectorhq.com/social-media-posting/category/queues/:queueId`
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.socialPlanner.fetchQueueById({
...
```nodejs
	...
	var req = unirest('GET', 'https://services.leadconnectorhq.com/social-media-posting/category/queues/:queueId')
...
```python
	...
	conn.request("GET", "/social-media-posting/category/queues/:queueId", payload, headers)
...
```php
	...
	$request = new Request('GET', 'https://services.leadconnectorhq.com/social-media-posting/category/queues/:queueId', $headers);
...
```java
	...
	HttpResponse<String> response = Unirest.get("https://services.leadconnectorhq.com/social-media-posting/category/queues/:queueId")
...
```powershell
	...
	$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/social-media-posting/category/queues/:queueId' -Method 'GET' -Headers $headers
