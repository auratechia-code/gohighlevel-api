...
**Method:** `POST` | **URL:** `https://services.leadconnectorhq.com/social-media-posting/oauth/:locationId/tiktok/accounts/:accountId`
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.socialPlanner.attachTiktokProfile({
...
```nodejs
	...
	var req = unirest('POST', 'https://services.leadconnectorhq.com/social-media-posting/oauth/:locationId/tiktok/accounts/:accountId')
...
```python
	...
	conn.request("POST", "/social-media-posting/oauth/:locationId/tiktok/accounts/:accountId", payload, headers)
...
```php
	...
	$request = new Request('POST', 'https://services.leadconnectorhq.com/social-media-posting/oauth/:locationId/tiktok/accounts/:accountId', $headers, $body);
...
```java
	...
	HttpResponse<String> response = Unirest.post("https://services.leadconnectorhq.com/social-media-posting/oauth/:locationId/tiktok/accounts/:accountId")
...
```powershell
	...
	$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/social-media-posting/oauth/:locationId/tiktok/accounts/:accountId' -Method 'POST' -Headers $headers -Body $body
