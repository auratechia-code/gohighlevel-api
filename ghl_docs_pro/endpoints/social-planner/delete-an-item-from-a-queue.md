...
**Method:** `DELETE` | **URL:** `https://services.leadconnectorhq.com/social-media-posting/category/queues/:queueId/items/:itemId`
...
| Name | Required | Description |
| :--- | :--- | :--- |
| `locationId` | ❌ | sessionId string Edit session ID Example: 60af88475f1b2c001f5d5f4b |
| `sessionId` | ❌ |  |
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.socialPlanner.deleteQueueItem({
...
```nodejs
	...
	var req = unirest('DELETE', 'https://services.leadconnectorhq.com/social-media-posting/category/queues/:queueId/items/:itemId')
...
```python
	...
	conn.request("DELETE", "/social-media-posting/category/queues/:queueId/items/:itemId", payload, headers)
...
```php
	...
	$request = new Request('DELETE', 'https://services.leadconnectorhq.com/social-media-posting/category/queues/:queueId/items/:itemId', $headers);
...
```java
	...
	HttpResponse<String> response = Unirest.delete("https://services.leadconnectorhq.com/social-media-posting/category/queues/:queueId/items/:itemId")
...
```powershell
	...
	$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/social-media-posting/category/queues/:queueId/items/:itemId' -Method 'DELETE' -Headers $headers
