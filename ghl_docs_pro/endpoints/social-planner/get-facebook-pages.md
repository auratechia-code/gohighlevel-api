...
**Method:** `GET` | **URL:** `https://services.leadconnectorhq.com/social-media-posting/oauth/:locationId/facebook/accounts/:accountId`
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.socialPlanner.getFacebookPageGroup({
...
```nodejs
	...
	var req = unirest('GET', 'https://services.leadconnectorhq.com/social-media-posting/oauth/:locationId/facebook/accounts/:accountId')
...
```python
	...
	conn.request("GET", "/social-media-posting/oauth/:locationId/facebook/accounts/:accountId", payload, headers)
...
```php
	...
	$request = new Request('GET', 'https://services.leadconnectorhq.com/social-media-posting/oauth/:locationId/facebook/accounts/:accountId', $headers);
...
```java
	...
	HttpResponse<String> response = Unirest.get("https://services.leadconnectorhq.com/social-media-posting/oauth/:locationId/facebook/accounts/:accountId")
...
```powershell
	...
	$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/social-media-posting/oauth/:locationId/facebook/accounts/:accountId' -Method 'GET' -Headers $headers
