...
**Method:** `GET` | **URL:** `https://services.leadconnectorhq.com/calendars/services/catalog/:serviceId`
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.calendars.getServiceCatalogById({
...
```nodejs
	...
	var req = unirest('GET', 'https://services.leadconnectorhq.com/calendars/services/catalog/:serviceId')
...
```python
	...
	conn.request("GET", "/calendars/services/catalog/:serviceId", payload, headers)
...
```php
	...
	$request = new Request('GET', 'https://services.leadconnectorhq.com/calendars/services/catalog/:serviceId', $headers);
...
```java
	...
	HttpResponse<String> response = Unirest.get("https://services.leadconnectorhq.com/calendars/services/catalog/:serviceId")
...
```powershell
	...
	$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/calendars/services/catalog/:serviceId' -Method 'GET' -Headers $headers
