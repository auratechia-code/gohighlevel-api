...
**Method:** `GET` | **URL:** `https://services.leadconnectorhq.com/calendars/schedules/:id`
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.calendars.getScheduleById({
...
```nodejs
	...
	var req = unirest('GET', 'https://services.leadconnectorhq.com/calendars/schedules/:id')
...
```python
	...
	conn.request("GET", "/calendars/schedules/:id", payload, headers)
...
```php
	...
	$request = new Request('GET', 'https://services.leadconnectorhq.com/calendars/schedules/:id', $headers);
...
```java
	...
	HttpResponse<String> response = Unirest.get("https://services.leadconnectorhq.com/calendars/schedules/:id")
...
```powershell
	...
	$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/calendars/schedules/:id' -Method 'GET' -Headers $headers
