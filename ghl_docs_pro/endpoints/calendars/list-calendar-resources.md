...
**Method:** `GET` | **URL:** `https://services.leadconnectorhq.com/calendars/resources/:resourceType`
...
| Name | Required | Description |
| :--- | :--- | :--- |
| `locationId` | ✅ | limit number required |
| `limit` | ✅ | skip number required |
| `skip` | ❌ |  |
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.calendars.fetchCalendarResources({
...
```nodejs
	...
	var req = unirest('GET', 'https://services.leadconnectorhq.com/calendars/resources/:resourceType')
...
```python
	...
	conn.request("GET", "/calendars/resources/:resourceType", payload, headers)
...
```php
	...
	$request = new Request('GET', 'https://services.leadconnectorhq.com/calendars/resources/:resourceType', $headers);
...
```java
	...
	HttpResponse<String> response = Unirest.get("https://services.leadconnectorhq.com/calendars/resources/:resourceType")
...
```powershell
	...
	$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/calendars/resources/:resourceType' -Method 'GET' -Headers $headers
