...
**Method:** `PUT` | **URL:** `https://services.leadconnectorhq.com/calendars/services/bookings/:bookingId`
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.calendars.updateServiceBooking({
...
```nodejs
	...
	var req = unirest('PUT', 'https://services.leadconnectorhq.com/calendars/services/bookings/:bookingId')
...
```python
	...
	conn.request("PUT", "/calendars/services/bookings/:bookingId", payload, headers)
...
```php
	...
	$request = new Request('PUT', 'https://services.leadconnectorhq.com/calendars/services/bookings/:bookingId', $headers, $body);
...
```java
	...
	HttpResponse<String> response = Unirest.put("https://services.leadconnectorhq.com/calendars/services/bookings/:bookingId")
