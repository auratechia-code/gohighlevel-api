...
**Method:** `GET` | **URL:** `https://services.leadconnectorhq.com/calendars/blocked-slots`
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.calendars.getBlockedSlots({
...
```nodejs
	...
	var req = unirest('GET', 'https://services.leadconnectorhq.com/calendars/blocked-slots')
...
```python
	...
	conn.request("GET", "/calendars/blocked-slots", payload, headers)
...
```php
	...
	curl_setopt_array($curl, array(
	  ...
	  CURLOPT_URL => 'https://services.leadconnectorhq.com/calendars/blocked-slots',
...
```php
	...
	$request = new Request('GET', 'https://services.leadconnectorhq.com/calendars/blocked-slots', $headers);
...
```php
	...
	$request->setUrl('https://services.leadconnectorhq.com/calendars/blocked-slots');
...
```php
	...
	$request->setRequestUrl('https://services.leadconnectorhq.com/calendars/blocked-slots');
...
```java
	...
	HttpResponse<String> response = Unirest.get("https://services.leadconnectorhq.com/calendars/blocked-slots")
...
```powershell
	...
	$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/calendars/blocked-slots' -Method 'GET' -Headers $headers
