...
**Method:** `POST` | **URL:** `https://services.leadconnectorhq.com/calendars/events/block-slots`
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.calendars.createBlockSlot({
...
```nodejs
	...
	var req = unirest('POST', 'https://services.leadconnectorhq.com/calendars/events/block-slots')
...
```python
	...
	conn.request("POST", "/calendars/events/block-slots", payload, headers)
...
```php
	...
	$request = new Request('POST', 'https://services.leadconnectorhq.com/calendars/events/block-slots', $headers, $body);
...
```php
	...
	$request->setUrl('https://services.leadconnectorhq.com/calendars/events/block-slots');
...
```php
	...
	$request->setRequestUrl('https://services.leadconnectorhq.com/calendars/events/block-slots');
...
```java
	...
	HttpResponse<String> response = Unirest.post("https://services.leadconnectorhq.com/calendars/events/block-slots")
