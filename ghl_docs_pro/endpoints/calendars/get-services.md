...
**Method:** `GET` | **URL:** `https://services.leadconnectorhq.com/calendars/services/catalog`
...
| :--- | :--- | :--- |
| `locationId` | ❌ | serviceCategoryId string Filter by service category ID Example: 65e5f6dfacf123513228d384 |
| `serviceCategoryId` | ❌ | isPrivate boolean Filter services: true = private only, false = public only, unset = all services |
| `isPrivate` | ❌ |  |
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.calendars.getServicesCatalog({

	    'locationId': '0007BWpSzSwfiuSl0tR2',

	    'serviceCategoryId': '65e5f6dfacf123513228d384',
...
```nodejs
	...
	var req = unirest('GET', 'https://services.leadconnectorhq.com/calendars/services/catalog')
...
```python
	...
	conn.request("GET", "/calendars/services/catalog", payload, headers)
...
```php
	...
	$request = new Request('GET', 'https://services.leadconnectorhq.com/calendars/services/catalog', $headers);
...
```java
	...
	HttpResponse<String> response = Unirest.get("https://services.leadconnectorhq.com/calendars/services/catalog")
...
```powershell
	...
	$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/calendars/services/catalog' -Method 'GET' -Headers $headers
