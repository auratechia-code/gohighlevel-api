...
**Method:** `GET` | **URL:** `https://services.leadconnectorhq.com/calendars/services/bookings/:bookingId`
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.calendars.getServiceBookingById({
...
```nodejs
	...
	var req = unirest('GET', 'https://services.leadconnectorhq.com/calendars/services/bookings/:bookingId')
...
```python
	...
	conn.request("GET", "/calendars/services/bookings/:bookingId", payload, headers)
...
```php
	...
	$request = new Request('GET', 'https://services.leadconnectorhq.com/calendars/services/bookings/:bookingId', $headers);
...
```java
	...
	HttpResponse<String> response = Unirest.get("https://services.leadconnectorhq.com/calendars/services/bookings/:bookingId")
...
```powershell
	...
	$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/calendars/services/bookings/:bookingId' -Method 'GET' -Headers $headers
