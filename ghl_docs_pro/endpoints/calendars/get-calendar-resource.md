...
**Method:** `GET` | **URL:** `https://services.leadconnectorhq.com/calendars/resources/:resourceType/:id`
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.calendars.getCalendarResource({
...
```nodejs
	...
	var req = unirest('GET', 'https://services.leadconnectorhq.com/calendars/resources/:resourceType/:id')
...
```python
	...
	conn.request("GET", "/calendars/resources/:resourceType/:id", payload, headers)
...
```php
	...
	$request = new Request('GET', 'https://services.leadconnectorhq.com/calendars/resources/:resourceType/:id', $headers);
...
```java
	...
	HttpResponse<String> response = Unirest.get("https://services.leadconnectorhq.com/calendars/resources/:resourceType/:id")
...
```powershell
	...
	$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/calendars/resources/:resourceType/:id' -Method 'GET' -Headers $headers
