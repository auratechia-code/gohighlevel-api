...
**Method:** `GET` | **URL:** `https://services.leadconnectorhq.com/calendars/services/locations/:serviceLocationId`
...
#### CURL
```curl
	curl -L 'https://services.leadconnectorhq.com/calendars/services/locations/:serviceLocationId' \
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.calendars.getServiceLocationById({
...
```nodejs
	...
	var req = unirest('GET', 'https://services.leadconnectorhq.com/calendars/services/locations/:serviceLocationId')
...
```python
	...
	conn.request("GET", "/calendars/services/locations/:serviceLocationId", payload, headers)
...
```php
	...
	$request = new Request('GET', 'https://services.leadconnectorhq.com/calendars/services/locations/:serviceLocationId', $headers);
...
```java
	...
	HttpResponse<String> response = Unirest.get("https://services.leadconnectorhq.com/calendars/services/locations/:serviceLocationId")
...
```powershell
	...
	$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/calendars/services/locations/:serviceLocationId' -Method 'GET' -Headers $headers
