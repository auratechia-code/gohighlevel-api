...
**Method:** `GET` | **URL:** `https://services.leadconnectorhq.com/calendars/services/locations`
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.calendars.getServiceLocations({
...
```nodejs
	...
	var req = unirest('GET', 'https://services.leadconnectorhq.com/calendars/services/locations')
...
```python
	...
	conn.request("GET", "/calendars/services/locations", payload, headers)
...
```php
	...
	$request = new Request('GET', 'https://services.leadconnectorhq.com/calendars/services/locations', $headers);
...
```java
	...
	HttpResponse<String> response = Unirest.get("https://services.leadconnectorhq.com/calendars/services/locations")
...
```powershell
	...
	$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/calendars/services/locations' -Method 'GET' -Headers $headers
