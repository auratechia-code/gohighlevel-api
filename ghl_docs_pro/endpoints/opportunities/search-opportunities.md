...
**Method:** `POST` | **URL:** `https://services.leadconnectorhq.com/opportunities/search`
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.opportunities.searchOpportunitiesAdvanced({
...
```nodejs
	...
	var req = unirest('POST', 'https://services.leadconnectorhq.com/opportunities/search')
...
```php
	...
	$request = new Request('POST', 'https://services.leadconnectorhq.com/opportunities/search', $headers, $body);
...
```java
	...
	HttpResponse<String> response = Unirest.post("https://services.leadconnectorhq.com/opportunities/search")
