...
**Method:** `GET` | **URL:** `https://services.leadconnectorhq.com/opportunities/:id`
...
```nodejs
	...
	var req = unirest('GET', 'https://services.leadconnectorhq.com/opportunities/:id')
...
```python
	...
	conn.request("GET", "/opportunities/:id", payload, headers)
...
```php
	...
	$request = new Request('GET', 'https://services.leadconnectorhq.com/opportunities/:id', $headers);
...
```java
	...
	HttpResponse<String> response = Unirest.get("https://services.leadconnectorhq.com/opportunities/:id")
...
```powershell
	...
	$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/opportunities/:id' -Method 'GET' -Headers $headers
