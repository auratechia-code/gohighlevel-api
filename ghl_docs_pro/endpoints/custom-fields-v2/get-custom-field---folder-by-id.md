...
**Method:** `GET` | **URL:** `https://services.leadconnectorhq.com/custom-fields/:id`
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.customFields.getCustomFieldById({
...
```nodejs
	...
	var req = unirest('GET', 'https://services.leadconnectorhq.com/custom-fields/:id')
...
```python
	...
	conn.request("GET", "/custom-fields/:id", payload, headers)
...
```php
	...
	$request = new Request('GET', 'https://services.leadconnectorhq.com/custom-fields/:id', $headers);
...
```java
	...
	HttpResponse<String> response = Unirest.get("https://services.leadconnectorhq.com/custom-fields/:id")
...
```powershell
	...
	$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/custom-fields/:id' -Method 'GET' -Headers $headers
