...
**Method:** `GET` | **URL:** `https://services.leadconnectorhq.com/brand-boards/:locationId/:id`
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.brandBoards.getBrandBoardById({
...
```nodejs
	...
	var req = unirest('GET', 'https://services.leadconnectorhq.com/brand-boards/:locationId/:id')
...
```python
	...
	conn.request("GET", "/brand-boards/:locationId/:id", payload, headers)
...
```php
	...
	$request = new Request('GET', 'https://services.leadconnectorhq.com/brand-boards/:locationId/:id', $headers);
...
```java
	...
	HttpResponse<String> response = Unirest.get("https://services.leadconnectorhq.com/brand-boards/:locationId/:id")
...
```powershell
	...
	$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/brand-boards/:locationId/:id' -Method 'GET' -Headers $headers
