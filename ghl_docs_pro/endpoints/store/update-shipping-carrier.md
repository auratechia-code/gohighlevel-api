...
**Method:** `PUT` | **URL:** `https://services.leadconnectorhq.com/store/shipping-carrier/:shippingCarrierId`
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.store.updateShippingCarrier({
...
```nodejs
	...
	var req = unirest('PUT', 'https://services.leadconnectorhq.com/store/shipping-carrier/:shippingCarrierId')
...
```python
	...
	conn.request("PUT", "/store/shipping-carrier/:shippingCarrierId", payload, headers)
...
```php
	...
	$request = new Request('PUT', 'https://services.leadconnectorhq.com/store/shipping-carrier/:shippingCarrierId', $headers, $body);
...
```java
	...
	HttpResponse<String> response = Unirest.put("https://services.leadconnectorhq.com/store/shipping-carrier/:shippingCarrierId")
