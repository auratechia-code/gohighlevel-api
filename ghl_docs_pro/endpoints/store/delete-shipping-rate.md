...
**Method:** `DELETE` | **URL:** `https://services.leadconnectorhq.com/store/shipping-zone/:shippingZoneId/shipping-rate/:shippingRateId`
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.store.deleteShippingRate({
...
```nodejs
	...
	var req = unirest('DELETE', 'https://services.leadconnectorhq.com/store/shipping-zone/:shippingZoneId/shipping-rate/:shippingRateId')
...
```python
	...
	conn.request("DELETE", "/store/shipping-zone/:shippingZoneId/shipping-rate/:shippingRateId", payload, headers)
...
```php
	...
	$request = new Request('DELETE', 'https://services.leadconnectorhq.com/store/shipping-zone/:shippingZoneId/shipping-rate/:shippingRateId', $headers);
...
```java
	...
	HttpResponse<String> response = Unirest.delete("https://services.leadconnectorhq.com/store/shipping-zone/:shippingZoneId/shipping-rate/:shippingRateId")
...
```powershell
	...
	$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/store/shipping-zone/:shippingZoneId/shipping-rate/:shippingRateId' -Method 'DELETE' -Headers $headers
