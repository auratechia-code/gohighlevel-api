...
**Method:** `PUT` | **URL:** `https://services.leadconnectorhq.com/store/shipping-zone/:shippingZoneId`
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.store.updateShippingZone({
...
```nodejs
	...
	var req = unirest('PUT', 'https://services.leadconnectorhq.com/store/shipping-zone/:shippingZoneId')
...
```python
	...
	conn.request("PUT", "/store/shipping-zone/:shippingZoneId", payload, headers)
...
```php
	...
	$request = new Request('PUT', 'https://services.leadconnectorhq.com/store/shipping-zone/:shippingZoneId', $headers, $body);
...
```java
	...
	HttpResponse<String> response = Unirest.put("https://services.leadconnectorhq.com/store/shipping-zone/:shippingZoneId")
