...
**Method:** `GET` | **URL:** `https://services.leadconnectorhq.com/store/shipping-zone/:shippingZoneId`
...
| `altType` | ❌ | withShippingRate boolean Include shipping rates array Example: |
| `withShippingRate` | ❌ |  |
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.store.getShippingZones({
...
```nodejs
	...
	var req = unirest('GET', 'https://services.leadconnectorhq.com/store/shipping-zone/:shippingZoneId')
...
```python
	...
	conn.request("GET", "/store/shipping-zone/:shippingZoneId", payload, headers)
...
```php
	...
	curl_setopt_array($curl, array(
	  ...
	  CURLOPT_URL => 'https://services.leadconnectorhq.com/store/shipping-zone/:shippingZoneId',
...
```php
	...
	$request = new Request('GET', 'https://services.leadconnectorhq.com/store/shipping-zone/:shippingZoneId', $headers);
...
```php
	...
	$request->setUrl('https://services.leadconnectorhq.com/store/shipping-zone/:shippingZoneId');
...
```php
	...
	$request->setRequestUrl('https://services.leadconnectorhq.com/store/shipping-zone/:shippingZoneId');
...
```java
	...
	HttpResponse<String> response = Unirest.get("https://services.leadconnectorhq.com/store/shipping-zone/:shippingZoneId")
...
```powershell
	...
	$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/store/shipping-zone/:shippingZoneId' -Method 'GET' -Headers $headers
