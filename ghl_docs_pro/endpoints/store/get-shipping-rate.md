...
**Method:** `GET` | **URL:** `https://services.leadconnectorhq.com/store/shipping-zone/:shippingZoneId/shipping-rate/:shippingRateId`
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.store.getShippingRates({
...
```nodejs
	...
	var req = unirest('GET', 'https://services.leadconnectorhq.com/store/shipping-zone/:shippingZoneId/shipping-rate/:shippingRateId')
...
```python
	...
	conn.request("GET", "/store/shipping-zone/:shippingZoneId/shipping-rate/:shippingRateId", payload, headers)
...
```php
	...
	$request = new Request('GET', 'https://services.leadconnectorhq.com/store/shipping-zone/:shippingZoneId/shipping-rate/:shippingRateId', $headers);
...
```java
	...
	HttpResponse<String> response = Unirest.get("https://services.leadconnectorhq.com/store/shipping-zone/:shippingZoneId/shipping-rate/:shippingRateId")
...
```powershell
	...
	$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/store/shipping-zone/:shippingZoneId/shipping-rate/:shippingRateId' -Method 'GET' -Headers $headers
