...
**Method:** `GET` | **URL:** `https://services.leadconnectorhq.com/store/shipping-zone`
...
| `offset` | ❌ | withShippingRate boolean Include shipping rates array Example: |
| `withShippingRate` | ❌ |  |
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.store.listShippingZones({
...
```nodejs
	...
	var req = unirest('GET', 'https://services.leadconnectorhq.com/store/shipping-zone')
...
```python
	...
	conn.request("GET", "/store/shipping-zone", payload, headers)
...
```php
	...
	curl_setopt_array($curl, array(
	  ...
	  CURLOPT_URL => 'https://services.leadconnectorhq.com/store/shipping-zone',
...
```php
	...
	$request = new Request('GET', 'https://services.leadconnectorhq.com/store/shipping-zone', $headers);
...
```php
	...
	$request->setUrl('https://services.leadconnectorhq.com/store/shipping-zone');
...
```php
	...
	$request->setRequestUrl('https://services.leadconnectorhq.com/store/shipping-zone');
...
```java
	...
	HttpResponse<String> response = Unirest.get("https://services.leadconnectorhq.com/store/shipping-zone")
...
```powershell
	...
	$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/store/shipping-zone' -Method 'GET' -Headers $headers
