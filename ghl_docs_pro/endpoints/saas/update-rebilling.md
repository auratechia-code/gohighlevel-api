...
**Method:** `POST` | **URL:** `https://services.leadconnectorhq.com/saas/update-rebilling/:companyId`
...
```nodejs
	...
	var req = unirest('POST', 'https://services.leadconnectorhq.com/saas/update-rebilling/:companyId')
...
```php
	...
	$request = new Request('POST', 'https://services.leadconnectorhq.com/saas/update-rebilling/:companyId', $headers, $body);
...
```php
	...
	$request->setUrl('https://services.leadconnectorhq.com/saas/update-rebilling/:companyId');
...
```php
	...
	$request->setRequestUrl('https://services.leadconnectorhq.com/saas/update-rebilling/:companyId');
...
```java
	...
	HttpResponse<String> response = Unirest.post("https://services.leadconnectorhq.com/saas/update-rebilling/:companyId")
