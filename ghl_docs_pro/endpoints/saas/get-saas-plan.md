...
**Method:** `GET` | **URL:** `https://services.leadconnectorhq.com/saas-api/public-api/saas-plan/:planId`
...
```nodejs
	...
	try {
	  ...
	  const response = await highLevel.saas.getSaasPlanDeprecated({
...
```nodejs
	...
	let config = {
	  ...
	  url: 'https://services.leadconnectorhq.com/saas-api/public-api/saas-plan/:planId',
...
```nodejs
	...
	var req = unirest('GET', 'https://services.leadconnectorhq.com/saas-api/public-api/saas-plan/:planId')
...
```python
	...
	conn.request("GET", "/saas-api/public-api/saas-plan/:planId", payload, headers)
...
```php
	...
	curl_setopt_array($curl, array(
	  ...
	  CURLOPT_URL => 'https://services.leadconnectorhq.com/saas-api/public-api/saas-plan/:planId',
...
```php
	...
	$request = new Request('GET', 'https://services.leadconnectorhq.com/saas-api/public-api/saas-plan/:planId', $headers);
...
```php
	...
	$request->setUrl('https://services.leadconnectorhq.com/saas-api/public-api/saas-plan/:planId');
...
```php
	...
	$request->setRequestUrl('https://services.leadconnectorhq.com/saas-api/public-api/saas-plan/:planId');
...
```java
	...
	HttpResponse<String> response = Unirest.get("https://services.leadconnectorhq.com/saas-api/public-api/saas-plan/:planId")
...
```ruby
	...
	url = URI("https://services.leadconnectorhq.com/saas-api/public-api/saas-plan/:planId")
...
```powershell
	...
	$response = Invoke-RestMethod 'https://services.leadconnectorhq.com/saas-api/public-api/saas-plan/:planId' -Method 'GET' -Headers $headers
