...
generated_at: "2026-03-28T17:50:27.796806"
tags: ["docs", "concept"]
---
...
The
first object
(buyer) would be a custom object representing the interested person.
The
second object
(property) would be a custom object representing the real estate listing.
The
association label
might be "Interested Buyer," indicating that the buyer has shown interest in the property.
...
Type:
string
Specifies the type of association (e.g.,
USER_DEFINED
or
SYSTEM_DEFINED
).
...
Type:
string
Indicates the relationship between the first and second object (e.g.,
MANY_TO_MANY
).
secondObjectKey
​
...
"firstObjectKey"
:
"custom_objects.real_estate_buyer"
,
"firstObjectLabel"
:
"Interested Buyer"
...
and
secondObjectKey
help define relationships between entities.
The
traceId
is useful for debugging and logging purposes.
Share your feedback
★
★
★
