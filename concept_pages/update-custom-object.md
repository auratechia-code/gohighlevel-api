...
generated_at: "2026-03-28T17:50:27.806432"
tags: ["docs", "concept"]
---
...
The
Update Custom Object
is triggered whenever a custom object is Updated. This webhook allows systems to listen for new custom objects and take appropriate actions based on the event.
Schema
​
...
singular
: The name of the object in singular form (e.g.,
"pet"
).
plural
: The name of the object in plural form (e.g.,
"pets"
).
description
​
...
Default:
"USER_DEFINED"
Specifies the type of object, currently supports only
USER_DEFINED
.
Example Payload
​
...
"timestamp"
:
"2025-02-10T08:26:05.961Z"
}
Additional Notes
​
Ensure your webhook listener is set up to handle
POST
requests.
The payload format may change in future versions; check for updates regularly.
The
key
field should be unique within a given
locationId
.
Share your feedback
★
